...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 9f 79 10 80 	movl   $0x8010799f,(%esp)
...
8010043a:	e8 f1 57 00 00       	call   80105c30 <uartputc>
...
801004ec:	e8 3f 57 00 00       	call   80105c30 <uartputc>
801004f1:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f8:	e8 33 57 00 00       	call   80105c30 <uartputc>
801004fd:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100504:	e8 27 57 00 00       	call   80105c30 <uartputc>
...
80100d34:	e8 17 5c 00 00       	call   80106950 <switchuvm>
  freevm(oldpgdir);
...
801020f1:	e8 4a 1f 00 00       	call   80104040 <wakeup>
...
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 26 13 00 00       	call   80104040 <wakeup>
    release(&log.lock);
...
80102d40:	e8 fb 12 00 00       	call   80104040 <wakeup>
  release(&log.lock);
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 a5 3a 00 00       	call   80106930 <switchkvm>
  seginit();
80102e8b:	e8 10 3a 00 00       	call   801068a0 <seginit>
  lapicinit();
...
80102ec1:	e8 3a 3f 00 00       	call   80106e00 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 cb 39 00 00       	call   801068a0 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 87 2c 00 00       	call   80105b70 <uartinit>
  pinit();         // process table
...
801031eb:	68 1d 75 10 80       	push   $0x8010751d
801031f0:	e8 9b d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801031f5:	83 ec 0c             	sub    $0xc,%esp
801031f8:	68 3c 75 10 80       	push   $0x8010753c
...
801032e8:	00 00 00 
  initlock(&p->lock, "pipe");
801032eb:	68 70 75 10 80       	push   $0x80107570
...
8010336f:	e8 cc 0c 00 00       	call   80104040 <wakeup>
...
801033b4:	e8 87 0c 00 00       	call   80104040 <wakeup>
...
80103444:	e8 f7 0b 00 00       	call   80104040 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103449:	5a                   	pop    %edx
8010344a:	59                   	pop    %ecx
8010344b:	53                   	push   %ebx
8010344c:	56                   	push   %esi
8010344d:	e8 2e 0a 00 00       	call   80103e80 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801034d3:	e8 68 0b 00 00       	call   80104040 <wakeup>
  release(&p->lock);
...
80103535:	e8 46 09 00 00       	call   80103e80 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
801035c7:	e8 74 0a 00 00       	call   80104040 <wakeup>
  release(&p->lock);
...
8010363f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103645:	e8 d6 0e 00 00       	call   80104520 <release>
...
80103667:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010366a:	c7 40 14 85 57 10 80 	movl   $0x80105785,0x14(%eax)
  p->context = (struct context*)sp;
...
80103679:	e8 f2 0e 00 00       	call   80104570 <memset>
...
801036a2:	e8 79 0e 00 00       	call   80104520 <release>
}
...
801036cb:	e8 50 0e 00 00       	call   80104520 <release>
...
80103716:	68 75 75 10 80       	push   $0x80107575
8010371b:	68 40 28 11 80       	push   $0x80112840
80103720:	e8 fb 0b 00 00       	call   80104320 <initlock>
}
...
8010375a:	68 7c 75 10 80       	push   $0x8010757c
...
80103772:	68 58 76 10 80       	push   $0x80107658
...
801037a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037a7:	e8 e4 0b 00 00       	call   80104390 <pushcli>
  c = mycpu();
801037ac:	e8 7f ff ff ff       	call   80103730 <mycpu>
  p = c->proc;
801037b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037b7:	e8 14 0c 00 00       	call   801043d0 <popcli>
}
...
801037e3:	e8 98 35 00 00       	call   80106d80 <setupkvm>
...
80103801:	e8 5a 32 00 00       	call   80106a60 <inituvm>
...
80103816:	e8 55 0d 00 00       	call   80104570 <memset>
...
80103876:	68 a5 75 10 80       	push   $0x801075a5
8010387b:	50                   	push   %eax
8010387c:	e8 cf 0e 00 00       	call   80104750 <safestrcpy>
  p->cwd = namei("/");
80103881:	c7 04 24 ae 75 10 80 	movl   $0x801075ae,(%esp)
...
801038ba:	68 8c 75 10 80       	push   $0x8010758c
...
801038d5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801038d8:	e8 b3 0a 00 00       	call   80104390 <pushcli>
  c = mycpu();
801038dd:	e8 4e fe ff ff       	call   80103730 <mycpu>
  p = c->proc;
801038e2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038e8:	e8 e3 0a 00 00       	call   801043d0 <popcli>
  if(n > 0){
...
801038fc:	e8 4f 30 00 00       	call   80106950 <switchuvm>
  return 0;
...
8010391a:	e8 81 32 00 00       	call   80106ba0 <allocuvm>
...
8010393a:	e8 91 33 00 00       	call   80106cd0 <deallocuvm>
...
80103956:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103959:	e8 32 0a 00 00       	call   80104390 <pushcli>
  c = mycpu();
8010395e:	e8 cd fd ff ff       	call   80103730 <mycpu>
  p = c->proc;
80103963:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103969:	e8 62 0a 00 00       	call   801043d0 <popcli>
  if((np = allocproc()) == 0){
...
80103988:	e8 c3 34 00 00       	call   80106e50 <copyuvm>
...
80103a01:	e8 4a 0d 00 00       	call   80104750 <safestrcpy>
  pid = np->pid;
80103a06:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a09:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
80103a10:	e8 4b 0a 00 00       	call   80104460 <acquire>
  np->state = RUNNABLE;
80103a15:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a1c:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
80103a23:	e8 f8 0a 00 00       	call   80104520 <release>
  return pid;
...
80103a76:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103a79:	e8 12 09 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103a7e:	e8 ad fc ff ff       	call   80103730 <mycpu>
  p = c->proc;
80103a83:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a89:	e8 42 09 00 00       	call   801043d0 <popcli>
  if((np = allocproc()) == 0){
80103a8e:	e8 5d fb ff ff       	call   801035f0 <allocproc>
80103a93:	85 c0                	test   %eax,%eax
80103a95:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103a98:	0f 84 d3 00 00 00    	je     80103b71 <vfork+0x101>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103a9e:	83 ec 08             	sub    $0x8,%esp
80103aa1:	ff 33                	pushl  (%ebx)
80103aa3:	ff 73 04             	pushl  0x4(%ebx)
80103aa6:	89 c7                	mov    %eax,%edi
80103aa8:	e8 a3 33 00 00       	call   80106e50 <copyuvm>
80103aad:	83 c4 10             	add    $0x10,%esp
80103ab0:	85 c0                	test   %eax,%eax
80103ab2:	89 47 04             	mov    %eax,0x4(%edi)
80103ab5:	0f 84 bd 00 00 00    	je     80103b78 <vfork+0x108>
  np->sz = curproc->sz;
...
80103ae6:	74 13                	je     80103afb <vfork+0x8b>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103ae8:	83 ec 0c             	sub    $0xc,%esp
80103aeb:	50                   	push   %eax
80103aec:	e8 ff d2 ff ff       	call   80100df0 <filedup>
...
80103b01:	75 dd                	jne    80103ae0 <vfork+0x70>
  np->cwd = idup(curproc->cwd);
...
80103b09:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103b0c:	e8 3f db ff ff       	call   80101650 <idup>
...
80103b21:	e8 2a 0c 00 00       	call   80104750 <safestrcpy>
  pid = np->pid;
80103b26:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103b29:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
80103b30:	e8 2b 09 00 00       	call   80104460 <acquire>
  pushcli();
80103b35:	e8 56 08 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103b3a:	e8 f1 fb ff ff       	call   80103730 <mycpu>
  p = c->proc;
80103b3f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103b45:	e8 86 08 00 00       	call   801043d0 <popcli>
  myproc()->state = SLEEPING; //father waiting 
80103b4a:	c7 46 0c 02 00 00 00 	movl   $0x2,0xc(%esi)
  np->state = RUNNABLE;
80103b51:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103b58:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
80103b5f:	e8 bc 09 00 00       	call   80104520 <release>
  return pid;
...
80103b70:	c3                   	ret    
    return -1;
80103b71:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103b76:	eb ef                	jmp    80103b67 <vfork+0xf7>
    kfree(np->kstack);
80103b78:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103b7b:	83 ec 0c             	sub    $0xc,%esp
80103b7e:	ff 73 08             	pushl  0x8(%ebx)
80103b81:	e8 8a e7 ff ff       	call   80102310 <kfree>
    np->kstack = 0;
80103b86:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
80103b8d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103b94:	83 c4 10             	add    $0x10,%esp
80103b97:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103b9c:	eb c9                	jmp    80103b67 <vfork+0xf7>
...
80103ba6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103ba9:	e8 82 fb ff ff       	call   80103730 <mycpu>
80103bae:	8d 78 04             	lea    0x4(%eax),%edi
80103bb1:	89 c6                	mov    %eax,%esi
  c->proc = 0;
...
80103bc1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bc4:	bb 74 28 11 80       	mov    $0x80112874,%ebx
    acquire(&ptable.lock);
80103bc9:	68 40 28 11 80       	push   $0x80112840
...
80103bf0:	e8 5b 2d 00 00       	call   80106950 <switchuvm>
...
80103bfb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c02:	e8 a4 0b 00 00       	call   801047ab <swtch>
      switchkvm();
80103c07:	e8 24 2d 00 00       	call   80106930 <switchkvm>
      c->proc = 0;
80103c0c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103c13:	00 00 00 
80103c16:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c19:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
80103c1f:	81 fb 74 4b 11 80    	cmp    $0x80114b74,%ebx
80103c25:	72 b9                	jb     80103be0 <scheduler+0x40>
    release(&ptable.lock);
80103c27:	83 ec 0c             	sub    $0xc,%esp
80103c2a:	68 40 28 11 80       	push   $0x80112840
80103c2f:	e8 ec 08 00 00       	call   80104520 <release>
    sti();
80103c34:	83 c4 10             	add    $0x10,%esp
80103c37:	eb 87                	jmp    80103bc0 <scheduler+0x20>
...
80103c44:	53                   	push   %ebx
  pushcli();
80103c45:	e8 46 07 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103c4a:	e8 e1 fa ff ff       	call   80103730 <mycpu>
  p = c->proc;
80103c4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c55:	e8 76 07 00 00       	call   801043d0 <popcli>
  if(!holding(&ptable.lock))
80103c5a:	83 ec 0c             	sub    $0xc,%esp
80103c5d:	68 40 28 11 80       	push   $0x80112840
80103c62:	e8 c9 07 00 00       	call   80104430 <holding>
80103c67:	83 c4 10             	add    $0x10,%esp
80103c6a:	85 c0                	test   %eax,%eax
80103c6c:	74 4f                	je     80103cbd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103c6e:	e8 bd fa ff ff       	call   80103730 <mycpu>
...
80103c87:	75 41                	jne    80103cca <sched+0x8a>
  intena = mycpu()->intena;
80103c89:	e8 a2 fa ff ff       	call   80103730 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103c8e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103c91:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c97:	e8 94 fa ff ff       	call   80103730 <mycpu>
80103c9c:	83 ec 08             	sub    $0x8,%esp
80103c9f:	ff 70 04             	pushl  0x4(%eax)
80103ca2:	53                   	push   %ebx
80103ca3:	e8 03 0b 00 00       	call   801047ab <swtch>
  mycpu()->intena = intena;
80103ca8:	e8 83 fa ff ff       	call   80103730 <mycpu>
}
...
80103d06:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d09:	e8 82 06 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103d0e:	e8 1d fa ff ff       	call   80103730 <mycpu>
  p = c->proc;
80103d13:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d19:	e8 b2 06 00 00       	call   801043d0 <popcli>
  if(curproc == initproc)
...
80103d64:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103d6b:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
...
80103d9f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103da6:	05 8c 00 00 00       	add    $0x8c,%eax
80103dab:	3d 74 4b 11 80       	cmp    $0x80114b74,%eax
80103db0:	72 e2                	jb     80103d94 <exit+0x94>
      p->parent = initproc;
80103db2:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103db8:	ba 74 28 11 80       	mov    $0x80112874,%edx
80103dbd:	eb 0f                	jmp    80103dce <exit+0xce>
80103dbf:	90                   	nop
80103dc0:	81 c2 8c 00 00 00    	add    $0x8c,%edx
80103dc6:	81 fa 74 4b 11 80    	cmp    $0x80114b74,%edx
...
80103dda:	75 e4                	jne    80103dc0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ddc:	b8 74 28 11 80       	mov    $0x80112874,%eax
80103de1:	eb 11                	jmp    80103df4 <exit+0xf4>
80103de3:	90                   	nop
80103de4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103de8:	05 8c 00 00 00       	add    $0x8c,%eax
80103ded:	3d 74 4b 11 80       	cmp    $0x80114b74,%eax
...
80103e17:	68 fd 75 10 80       	push   $0x801075fd
80103e1c:	e8 6f c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e21:	83 ec 0c             	sub    $0xc,%esp
80103e24:	68 f0 75 10 80       	push   $0x801075f0
...
80103e37:	68 40 28 11 80       	push   $0x80112840
80103e3c:	e8 1f 06 00 00       	call   80104460 <acquire>
  pushcli();
80103e41:	e8 4a 05 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103e46:	e8 e5 f8 ff ff       	call   80103730 <mycpu>
  p = c->proc;
80103e4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e51:	e8 7a 05 00 00       	call   801043d0 <popcli>
  myproc()->state = RUNNABLE;
80103e56:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103e5d:	e8 de fd ff ff       	call   80103c40 <sched>
  release(&ptable.lock);
80103e62:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
...
80103e8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e8f:	e8 fc 04 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103e94:	e8 97 f8 ff ff       	call   80103730 <mycpu>
  p = c->proc;
80103e99:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e9f:	e8 2c 05 00 00       	call   801043d0 <popcli>
  if(p == 0)
...
80103eb0:	81 fe 40 28 11 80    	cmp    $0x80112840,%esi
80103eb6:	74 50                	je     80103f08 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103eb8:	83 ec 0c             	sub    $0xc,%esp
80103ebb:	68 40 28 11 80       	push   $0x80112840
...
80103edc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103ee3:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
...
80103f8f:	74 37                	je     80103fc8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f91:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
      havekids = 1;
80103f97:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f9c:	81 fb 74 4b 11 80    	cmp    $0x80114b74,%ebx
...
80103fb2:	68 40 28 11 80       	push   $0x80112840
...
80103fda:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fe1:	e8 1a 2d 00 00       	call   80106d00 <freevm>
        release(&ptable.lock);
80103fe6:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
        p->pid = 0;
...
80104006:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010400d:	e8 0e 05 00 00       	call   80104520 <release>
        return pid;
...
80104021:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104026:	68 40 28 11 80       	push   $0x80112840
8010402b:	e8 f0 04 00 00       	call   80104520 <release>
      return -1;
...
80104047:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010404a:	68 40 28 11 80       	push   $0x80112840
8010404f:	e8 0c 04 00 00       	call   80104460 <acquire>
80104054:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104057:	b8 74 28 11 80       	mov    $0x80112874,%eax
8010405c:	eb 0e                	jmp    8010406c <wakeup+0x2c>
8010405e:	66 90                	xchg   %ax,%ax
80104060:	05 8c 00 00 00       	add    $0x8c,%eax
80104065:	3d 74 4b 11 80       	cmp    $0x80114b74,%eax
...
80104077:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010407e:	05 8c 00 00 00       	add    $0x8c,%eax
80104083:	3d 74 4b 11 80       	cmp    $0x80114b74,%eax
80104088:	72 e2                	jb     8010406c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010408a:	c7 45 08 40 28 11 80 	movl   $0x80112840,0x8(%ebp)
}
...
801040e8:	68 40 28 11 80       	push   $0x80112840
801040ed:	e8 2e 04 00 00       	call   80104520 <release>
      return 0;
...
80104103:	68 40 28 11 80       	push   $0x80112840
80104108:	e8 13 04 00 00       	call   80104520 <release>
  return -1;
...
80104126:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104129:	bb 74 28 11 80       	mov    $0x80112874,%ebx
{
...
8010413b:	68 9f 79 10 80       	push   $0x8010799f
80104140:	e8 1b c5 ff ff       	call   80100660 <cprintf>
80104145:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104148:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
8010414e:	81 fb 74 4b 11 80    	cmp    $0x80114b74,%ebx
...
80104161:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104164:	ba 20 76 10 80       	mov    $0x80107620,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104169:	77 11                	ja     8010417c <procdump+0x5c>
8010416b:	8b 14 85 80 76 10 80 	mov    -0x7fef8980(,%eax,4),%edx
      state = "???";
80104172:	b8 20 76 10 80       	mov    $0x80107620,%eax
...
80104184:	68 24 76 10 80       	push   $0x80107624
...
801041c9:	68 61 70 10 80       	push   $0x80107061
...
801041fa:	68 98 76 10 80       	push   $0x80107698
...
80104263:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104269:	e8 32 f5 ff ff       	call   801037a0 <myproc>
...
801042f3:	e8 a8 f4 ff ff       	call   801037a0 <myproc>
...
80104399:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010439a:	e8 91 f3 ff ff       	call   80103730 <mycpu>
...
801043af:	e8 7c f3 ff ff       	call   80103730 <mycpu>
801043b4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801043ba:	e8 71 f3 ff ff       	call   80103730 <mycpu>
...
801043fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104400:	e8 2b f3 ff ff       	call   80103730 <mycpu>
...
80104415:	68 a3 76 10 80       	push   $0x801076a3
8010441a:	e8 71 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010441f:	83 ec 0c             	sub    $0xc,%esp
80104422:	68 ba 76 10 80       	push   $0x801076ba
...
80104448:	e8 e3 f2 ff ff       	call   80103730 <mycpu>
...
801044a4:	e8 87 f2 ff ff       	call   80103730 <mycpu>
...
80104507:	68 c1 76 10 80       	push   $0x801076c1
...
8010455c:	68 c9 76 10 80       	push   $0x801076c9
...
801047c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801047ca:	e8 d1 ef ff ff       	call   801037a0 <myproc>
...
80104807:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010480a:	e8 91 ef ff ff       	call   801037a0 <myproc>
...
80104883:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104886:	e8 15 ef ff ff       	call   801037a0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801048c8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801048cb:	e8 d0 ee ff ff       	call   801037a0 <myproc>
...
80104964:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104967:	e8 34 ee ff ff       	call   801037a0 <myproc>
...
80104977:	83 fa 16             	cmp    $0x16,%edx
8010497a:	77 1c                	ja     80104998 <syscall+0x38>
8010497c:	8b 14 85 00 77 10 80 	mov    -0x7fef8900(,%eax,4),%edx
...
801049a0:	68 d1 76 10 80       	push   $0x801076d1
...
80104af4:	68 7c 77 10 80       	push   $0x8010777c
...
80104b0c:	68 7b 77 10 80       	push   $0x8010777b
...
80104b25:	68 6f 77 10 80       	push   $0x8010776f
...
80104b3a:	68 7e 77 10 80       	push   $0x8010777e
80104b3f:	e8 4c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b44:	83 ec 0c             	sub    $0xc,%esp
80104b47:	68 60 77 10 80       	push   $0x80107760
...
80104b84:	e8 17 ec ff ff       	call   801037a0 <myproc>
...
80104bc9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104bcb:	e8 d0 eb ff ff       	call   801037a0 <myproc>
...
80104d13:	78 2b                	js     80104d40 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104d15:	e8 86 ea ff ff       	call   801037a0 <myproc>
...
80104f39:	58                   	pop    %eax
80104f3a:	5a                   	pop    %edx
80104f3b:	68 7c 77 10 80       	push   $0x8010777c
...
80104f54:	68 7b 77 10 80       	push   $0x8010777b
...
8010514f:	0f 84 a6 00 00 00    	je     801051fb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105155:	e8 46 e6 ff ff       	call   801037a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105325:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105328:	e8 73 e4 ff ff       	call   801037a0 <myproc>
...
801054ff:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105501:	e8 9a e2 ff ff       	call   801037a0 <myproc>
...
80105527:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010552a:	e8 71 e2 ff ff       	call   801037a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105561:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105568:	e8 33 e2 ff ff       	call   801037a0 <myproc>
...
801055a3:	5d                   	pop    %ebp
  return fork();
801055a4:	e9 a7 e3 ff ff       	jmp    80103950 <fork>
...
801055b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801055b6:	e8 45 e7 ff ff       	call   80103d00 <exit>
...
801055c3:	5d                   	pop    %ebp
  return wait();
801055c4:	e9 77 e9 ff ff       	jmp    80103f40 <wait>
...
801055ee:	e8 ad ea ff ff       	call   801040a0 <kill>
...
80105613:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105616:	e8 85 e1 ff ff       	call   801037a0 <myproc>
...
80105637:	78 27                	js     80105660 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105639:	e8 62 e1 ff ff       	call   801037a0 <myproc>
  if(growproc(n) < 0)
...
80105646:	e8 85 e2 ff ff       	call   801038d0 <growproc>
...
801056bd:	e8 be e7 ff ff       	call   80103e80 <sleep>
  while(ticks - ticks0 < n){
...
801056cf:	73 2f                	jae    80105700 <sys_sleep+0x90>
    if(myproc()->killed){
801056d1:	e8 ca e0 ff ff       	call   801037a0 <myproc>
...
80105763:	83 ec 08             	sub    $0x8,%esp
  return vfork();
80105766:	e8 05 e3 ff ff       	call   80103a70 <vfork>
}
8010576b:	c9                   	leave  
8010576c:	c3                   	ret    
...
801057a7:	c7 04 c5 c2 4b 11 80 	movl   $0x8e000008,-0x7feeb43e(,%eax,8)
801057ae:	08 00 00 8e 
801057b2:	66 89 14 c5 c0 4b 11 	mov    %dx,-0x7feeb440(,%eax,8)
801057b9:	80 
801057ba:	c1 ea 10             	shr    $0x10,%edx
801057bd:	66 89 14 c5 c6 4b 11 	mov    %dx,-0x7feeb43a(,%eax,8)
801057c4:	80 
  for(i = 0; i < 256; i++)
...
801057d4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057d7:	c7 05 c2 4d 11 80 08 	movl   $0xef000008,0x80114dc2
801057de:	00 00 ef 
  initlock(&tickslock, "time");
801057e1:	68 c1 77 10 80       	push   $0x801077c1
801057e6:	68 80 4b 11 80       	push   $0x80114b80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057eb:	66 a3 c0 4d 11 80    	mov    %ax,0x80114dc0
801057f1:	c1 e8 10             	shr    $0x10,%eax
801057f4:	66 a3 c6 4d 11 80    	mov    %ax,0x80114dc6
  initlock(&tickslock, "time");
801057fa:	e8 21 eb ff ff       	call   80104320 <initlock>
}
...
8010581b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010581f:	b8 c0 4b 11 80       	mov    $0x80114bc0,%eax
...
80105870:	e8 2b df ff ff       	call   801037a0 <myproc>
80105875:	85 c0                	test   %eax,%eax
80105877:	8b 5f 38             	mov    0x38(%edi),%ebx
8010587a:	0f 84 3c 02 00 00    	je     80105abc <trap+0x27c>
80105880:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105884:	0f 84 32 02 00 00    	je     80105abc <trap+0x27c>
...
80105890:	e8 eb de ff ff       	call   80103780 <cpuid>
...
801058de:	e8 bd de ff ff       	call   801037a0 <myproc>
801058e3:	85 c0                	test   %eax,%eax
801058e5:	74 1d                	je     80105904 <trap+0xc4>
801058e7:	e8 b4 de ff ff       	call   801037a0 <myproc>
...
801058fe:	0f 84 74 01 00 00    	je     80105a78 <trap+0x238>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105904:	e8 97 de ff ff       	call   801037a0 <myproc>
80105909:	85 c0                	test   %eax,%eax
8010590b:	74 0b                	je     80105918 <trap+0xd8>
8010590d:	e8 8e de ff ff       	call   801037a0 <myproc>
...
80105916:	74 68                	je     80105980 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105918:	e8 83 de ff ff       	call   801037a0 <myproc>
...
80105942:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105948:	e8 53 de ff ff       	call   801037a0 <myproc>
8010594d:	8b 58 24             	mov    0x24(%eax),%ebx
80105950:	85 db                	test   %ebx,%ebx
80105952:	0f 85 10 01 00 00    	jne    80105a68 <trap+0x228>
    myproc()->tf = tf;
80105958:	e8 43 de ff ff       	call   801037a0 <myproc>
8010595d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105960:	e8 fb ef ff ff       	call   80104960 <syscall>
    if(myproc()->killed)
80105965:	e8 36 de ff ff       	call   801037a0 <myproc>
...
80105977:	5d                   	pop    %ebp
      exit();
80105978:	e9 83 e3 ff ff       	jmp    80103d00 <exit>
...
80105986:	e8 15 de ff ff       	call   801037a0 <myproc>
8010598b:	8b 50 7c             	mov    0x7c(%eax),%edx
8010598e:	8d 4a 01             	lea    0x1(%edx),%ecx
80105991:	83 fa 04             	cmp    $0x4,%edx
80105994:	89 48 7c             	mov    %ecx,0x7c(%eax)
80105997:	0f 8e 7b ff ff ff    	jle    80105918 <trap+0xd8>
          myproc()->slot = 0;
8010599d:	e8 fe dd ff ff       	call   801037a0 <myproc>
801059a2:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
          yield();
801059a9:	e8 82 e4 ff ff       	call   80103e30 <yield>
801059ae:	e9 65 ff ff ff       	jmp    80105918 <trap+0xd8>
801059b3:	90                   	nop
801059b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801059b8:	e8 c3 dd ff ff       	call   80103780 <cpuid>
801059bd:	85 c0                	test   %eax,%eax
801059bf:	0f 84 c3 00 00 00    	je     80105a88 <trap+0x248>
    lapiceoi();
801059c5:	e8 86 cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059ca:	e8 d1 dd ff ff       	call   801037a0 <myproc>
801059cf:	85 c0                	test   %eax,%eax
801059d1:	0f 85 10 ff ff ff    	jne    801058e7 <trap+0xa7>
801059d7:	e9 28 ff ff ff       	jmp    80105904 <trap+0xc4>
801059dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801059e0:	e8 2b cc ff ff       	call   80102610 <kbdintr>
    lapiceoi();
801059e5:	e8 66 cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059ea:	e8 b1 dd ff ff       	call   801037a0 <myproc>
801059ef:	85 c0                	test   %eax,%eax
801059f1:	0f 85 f0 fe ff ff    	jne    801058e7 <trap+0xa7>
801059f7:	e9 08 ff ff ff       	jmp    80105904 <trap+0xc4>
801059fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105a00:	e8 5b 02 00 00       	call   80105c60 <uartintr>
    lapiceoi();
80105a05:	e8 46 cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a0a:	e8 91 dd ff ff       	call   801037a0 <myproc>
80105a0f:	85 c0                	test   %eax,%eax
80105a11:	0f 85 d0 fe ff ff    	jne    801058e7 <trap+0xa7>
80105a17:	e9 e8 fe ff ff       	jmp    80105904 <trap+0xc4>
80105a1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105a20:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105a24:	8b 77 38             	mov    0x38(%edi),%esi
80105a27:	e8 54 dd ff ff       	call   80103780 <cpuid>
80105a2c:	56                   	push   %esi
80105a2d:	53                   	push   %ebx
80105a2e:	50                   	push   %eax
80105a2f:	68 cc 77 10 80       	push   $0x801077cc
80105a34:	e8 27 ac ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105a39:	e8 12 cd ff ff       	call   80102750 <lapiceoi>
    break;
80105a3e:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a41:	e8 5a dd ff ff       	call   801037a0 <myproc>
80105a46:	85 c0                	test   %eax,%eax
80105a48:	0f 85 99 fe ff ff    	jne    801058e7 <trap+0xa7>
80105a4e:	e9 b1 fe ff ff       	jmp    80105904 <trap+0xc4>
80105a53:	90                   	nop
80105a54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105a58:	e8 23 c6 ff ff       	call   80102080 <ideintr>
80105a5d:	e9 63 ff ff ff       	jmp    801059c5 <trap+0x185>
80105a62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105a68:	e8 93 e2 ff ff       	call   80103d00 <exit>
80105a6d:	e9 e6 fe ff ff       	jmp    80105958 <trap+0x118>
80105a72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105a78:	e8 83 e2 ff ff       	call   80103d00 <exit>
80105a7d:	e9 82 fe ff ff       	jmp    80105904 <trap+0xc4>
80105a82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105a88:	83 ec 0c             	sub    $0xc,%esp
80105a8b:	68 80 4b 11 80       	push   $0x80114b80
80105a90:	e8 cb e9 ff ff       	call   80104460 <acquire>
      wakeup(&ticks);
80105a95:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
      ticks++;
80105a9c:	83 05 c0 53 11 80 01 	addl   $0x1,0x801153c0
      wakeup(&ticks);
80105aa3:	e8 98 e5 ff ff       	call   80104040 <wakeup>
      release(&tickslock);
80105aa8:	c7 04 24 80 4b 11 80 	movl   $0x80114b80,(%esp)
80105aaf:	e8 6c ea ff ff       	call   80104520 <release>
80105ab4:	83 c4 10             	add    $0x10,%esp
80105ab7:	e9 09 ff ff ff       	jmp    801059c5 <trap+0x185>
80105abc:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105abf:	e8 bc dc ff ff       	call   80103780 <cpuid>
...
80105acd:	68 f0 77 10 80       	push   $0x801077f0
80105ad2:	e8 89 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105ad7:	83 c4 14             	add    $0x14,%esp
80105ada:	68 c6 77 10 80       	push   $0x801077c6
80105adf:	e8 ac a8 ff ff       	call   80100390 <panic>
...
80105b45:	e8 26 cc ff ff       	call   80102770 <microdelay>
...
80105bdc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105bdf:	bb e8 78 10 80       	mov    $0x801078e8,%ebx
  ioapicenable(IRQ_COM1, 0);
80105be4:	6a 00                	push   $0x0
80105be6:	6a 04                	push   $0x4
80105be8:	e8 e3 c6 ff ff       	call   801022d0 <ioapicenable>
...
80105c6b:	e8 a0 ab ff ff       	call   80100810 <consoleintr>
}
...
80105c77:	6a 00                	push   $0x0
  jmp alltraps
80105c79:	e9 ef fa ff ff       	jmp    8010576d <alltraps>
...
80105c80:	6a 01                	push   $0x1
  jmp alltraps
80105c82:	e9 e6 fa ff ff       	jmp    8010576d <alltraps>
...
80105c89:	6a 02                	push   $0x2
  jmp alltraps
80105c8b:	e9 dd fa ff ff       	jmp    8010576d <alltraps>
...
80105c92:	6a 03                	push   $0x3
  jmp alltraps
80105c94:	e9 d4 fa ff ff       	jmp    8010576d <alltraps>
...
80105c9b:	6a 04                	push   $0x4
  jmp alltraps
80105c9d:	e9 cb fa ff ff       	jmp    8010576d <alltraps>
...
80105cad:	6a 06                	push   $0x6
  jmp alltraps
80105caf:	e9 b9 fa ff ff       	jmp    8010576d <alltraps>
...
80105cb6:	6a 07                	push   $0x7
  jmp alltraps
80105cb8:	e9 b0 fa ff ff       	jmp    8010576d <alltraps>
...
80105cbd:	6a 08                	push   $0x8
  jmp alltraps
80105cbf:	e9 a9 fa ff ff       	jmp    8010576d <alltraps>
...
80105cc6:	6a 09                	push   $0x9
  jmp alltraps
80105cc8:	e9 a0 fa ff ff       	jmp    8010576d <alltraps>
...
80105ccd:	6a 0a                	push   $0xa
  jmp alltraps
80105ccf:	e9 99 fa ff ff       	jmp    8010576d <alltraps>
...
80105cd4:	6a 0b                	push   $0xb
  jmp alltraps
80105cd6:	e9 92 fa ff ff       	jmp    8010576d <alltraps>
...
80105ce2:	6a 0d                	push   $0xd
  jmp alltraps
80105ce4:	e9 84 fa ff ff       	jmp    8010576d <alltraps>
...
80105ce9:	6a 0e                	push   $0xe
  jmp alltraps
80105ceb:	e9 7d fa ff ff       	jmp    8010576d <alltraps>
...
80105cf2:	6a 0f                	push   $0xf
  jmp alltraps
80105cf4:	e9 74 fa ff ff       	jmp    8010576d <alltraps>
...
80105cfb:	6a 10                	push   $0x10
  jmp alltraps
80105cfd:	e9 6b fa ff ff       	jmp    8010576d <alltraps>
...
80105d02:	6a 11                	push   $0x11
  jmp alltraps
80105d04:	e9 64 fa ff ff       	jmp    8010576d <alltraps>
...
80105d0b:	6a 12                	push   $0x12
  jmp alltraps
80105d0d:	e9 5b fa ff ff       	jmp    8010576d <alltraps>
...
80105d14:	6a 13                	push   $0x13
  jmp alltraps
80105d16:	e9 52 fa ff ff       	jmp    8010576d <alltraps>
...
80105d1d:	6a 14                	push   $0x14
  jmp alltraps
80105d1f:	e9 49 fa ff ff       	jmp    8010576d <alltraps>
...
80105d26:	6a 15                	push   $0x15
  jmp alltraps
80105d28:	e9 40 fa ff ff       	jmp    8010576d <alltraps>
...
80105d2f:	6a 16                	push   $0x16
  jmp alltraps
80105d31:	e9 37 fa ff ff       	jmp    8010576d <alltraps>
...
80105d38:	6a 17                	push   $0x17
  jmp alltraps
80105d3a:	e9 2e fa ff ff       	jmp    8010576d <alltraps>
...
80105d41:	6a 18                	push   $0x18
  jmp alltraps
80105d43:	e9 25 fa ff ff       	jmp    8010576d <alltraps>
...
80105d4a:	6a 19                	push   $0x19
  jmp alltraps
80105d4c:	e9 1c fa ff ff       	jmp    8010576d <alltraps>
...
80105d53:	6a 1a                	push   $0x1a
  jmp alltraps
80105d55:	e9 13 fa ff ff       	jmp    8010576d <alltraps>
...
80105d5c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d5e:	e9 0a fa ff ff       	jmp    8010576d <alltraps>
...
80105d65:	6a 1c                	push   $0x1c
  jmp alltraps
80105d67:	e9 01 fa ff ff       	jmp    8010576d <alltraps>
...
80105d6e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d70:	e9 f8 f9 ff ff       	jmp    8010576d <alltraps>
...
80105d77:	6a 1e                	push   $0x1e
  jmp alltraps
80105d79:	e9 ef f9 ff ff       	jmp    8010576d <alltraps>
...
80105d80:	6a 1f                	push   $0x1f
  jmp alltraps
80105d82:	e9 e6 f9 ff ff       	jmp    8010576d <alltraps>
...
80105d89:	6a 20                	push   $0x20
  jmp alltraps
80105d8b:	e9 dd f9 ff ff       	jmp    8010576d <alltraps>
...
80105d92:	6a 21                	push   $0x21
  jmp alltraps
80105d94:	e9 d4 f9 ff ff       	jmp    8010576d <alltraps>
...
80105d9b:	6a 22                	push   $0x22
  jmp alltraps
80105d9d:	e9 cb f9 ff ff       	jmp    8010576d <alltraps>
...
80105da4:	6a 23                	push   $0x23
  jmp alltraps
80105da6:	e9 c2 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dad:	6a 24                	push   $0x24
  jmp alltraps
80105daf:	e9 b9 f9 ff ff       	jmp    8010576d <alltraps>
...
80105db6:	6a 25                	push   $0x25
  jmp alltraps
80105db8:	e9 b0 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dbf:	6a 26                	push   $0x26
  jmp alltraps
80105dc1:	e9 a7 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dc8:	6a 27                	push   $0x27
  jmp alltraps
80105dca:	e9 9e f9 ff ff       	jmp    8010576d <alltraps>
...
80105dd1:	6a 28                	push   $0x28
  jmp alltraps
80105dd3:	e9 95 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dda:	6a 29                	push   $0x29
  jmp alltraps
80105ddc:	e9 8c f9 ff ff       	jmp    8010576d <alltraps>
...
80105de3:	6a 2a                	push   $0x2a
  jmp alltraps
80105de5:	e9 83 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dec:	6a 2b                	push   $0x2b
  jmp alltraps
80105dee:	e9 7a f9 ff ff       	jmp    8010576d <alltraps>
...
80105df5:	6a 2c                	push   $0x2c
  jmp alltraps
80105df7:	e9 71 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dfe:	6a 2d                	push   $0x2d
  jmp alltraps
80105e00:	e9 68 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e07:	6a 2e                	push   $0x2e
  jmp alltraps
80105e09:	e9 5f f9 ff ff       	jmp    8010576d <alltraps>
...
80105e10:	6a 2f                	push   $0x2f
  jmp alltraps
80105e12:	e9 56 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e19:	6a 30                	push   $0x30
  jmp alltraps
80105e1b:	e9 4d f9 ff ff       	jmp    8010576d <alltraps>
...
80105e22:	6a 31                	push   $0x31
  jmp alltraps
80105e24:	e9 44 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e2b:	6a 32                	push   $0x32
  jmp alltraps
80105e2d:	e9 3b f9 ff ff       	jmp    8010576d <alltraps>
...
80105e34:	6a 33                	push   $0x33
  jmp alltraps
80105e36:	e9 32 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e3d:	6a 34                	push   $0x34
  jmp alltraps
80105e3f:	e9 29 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e46:	6a 35                	push   $0x35
  jmp alltraps
80105e48:	e9 20 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e4f:	6a 36                	push   $0x36
  jmp alltraps
80105e51:	e9 17 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e58:	6a 37                	push   $0x37
  jmp alltraps
80105e5a:	e9 0e f9 ff ff       	jmp    8010576d <alltraps>
...
80105e61:	6a 38                	push   $0x38
  jmp alltraps
80105e63:	e9 05 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e6a:	6a 39                	push   $0x39
  jmp alltraps
80105e6c:	e9 fc f8 ff ff       	jmp    8010576d <alltraps>
...
80105e73:	6a 3a                	push   $0x3a
  jmp alltraps
80105e75:	e9 f3 f8 ff ff       	jmp    8010576d <alltraps>
...
80105e7c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e7e:	e9 ea f8 ff ff       	jmp    8010576d <alltraps>
...
80105e85:	6a 3c                	push   $0x3c
  jmp alltraps
80105e87:	e9 e1 f8 ff ff       	jmp    8010576d <alltraps>
...
80105e8e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e90:	e9 d8 f8 ff ff       	jmp    8010576d <alltraps>
...
80105e97:	6a 3e                	push   $0x3e
  jmp alltraps
80105e99:	e9 cf f8 ff ff       	jmp    8010576d <alltraps>
...
80105ea0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ea2:	e9 c6 f8 ff ff       	jmp    8010576d <alltraps>
...
80105ea9:	6a 40                	push   $0x40
  jmp alltraps
80105eab:	e9 bd f8 ff ff       	jmp    8010576d <alltraps>
...
80105eb2:	6a 41                	push   $0x41
  jmp alltraps
80105eb4:	e9 b4 f8 ff ff       	jmp    8010576d <alltraps>
...
80105ebb:	6a 42                	push   $0x42
  jmp alltraps
80105ebd:	e9 ab f8 ff ff       	jmp    8010576d <alltraps>
...
80105ec4:	6a 43                	push   $0x43
  jmp alltraps
80105ec6:	e9 a2 f8 ff ff       	jmp    8010576d <alltraps>
...
80105ecd:	6a 44                	push   $0x44
  jmp alltraps
80105ecf:	e9 99 f8 ff ff       	jmp    8010576d <alltraps>
...
80105ed6:	6a 45                	push   $0x45
  jmp alltraps
80105ed8:	e9 90 f8 ff ff       	jmp    8010576d <alltraps>
...
80105edf:	6a 46                	push   $0x46
  jmp alltraps
80105ee1:	e9 87 f8 ff ff       	jmp    8010576d <alltraps>
...
80105ee8:	6a 47                	push   $0x47
  jmp alltraps
80105eea:	e9 7e f8 ff ff       	jmp    8010576d <alltraps>
...
80105ef1:	6a 48                	push   $0x48
  jmp alltraps
80105ef3:	e9 75 f8 ff ff       	jmp    8010576d <alltraps>
...
80105efa:	6a 49                	push   $0x49
  jmp alltraps
80105efc:	e9 6c f8 ff ff       	jmp    8010576d <alltraps>
...
80105f03:	6a 4a                	push   $0x4a
  jmp alltraps
80105f05:	e9 63 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f0c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f0e:	e9 5a f8 ff ff       	jmp    8010576d <alltraps>
...
80105f15:	6a 4c                	push   $0x4c
  jmp alltraps
80105f17:	e9 51 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f1e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f20:	e9 48 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f27:	6a 4e                	push   $0x4e
  jmp alltraps
80105f29:	e9 3f f8 ff ff       	jmp    8010576d <alltraps>
...
80105f30:	6a 4f                	push   $0x4f
  jmp alltraps
80105f32:	e9 36 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f39:	6a 50                	push   $0x50
  jmp alltraps
80105f3b:	e9 2d f8 ff ff       	jmp    8010576d <alltraps>
...
80105f42:	6a 51                	push   $0x51
  jmp alltraps
80105f44:	e9 24 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f4b:	6a 52                	push   $0x52
  jmp alltraps
80105f4d:	e9 1b f8 ff ff       	jmp    8010576d <alltraps>
...
80105f54:	6a 53                	push   $0x53
  jmp alltraps
80105f56:	e9 12 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f5d:	6a 54                	push   $0x54
  jmp alltraps
80105f5f:	e9 09 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f66:	6a 55                	push   $0x55
  jmp alltraps
80105f68:	e9 00 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f6f:	6a 56                	push   $0x56
  jmp alltraps
80105f71:	e9 f7 f7 ff ff       	jmp    8010576d <alltraps>
...
80105f78:	6a 57                	push   $0x57
  jmp alltraps
80105f7a:	e9 ee f7 ff ff       	jmp    8010576d <alltraps>
...
80105f81:	6a 58                	push   $0x58
  jmp alltraps
80105f83:	e9 e5 f7 ff ff       	jmp    8010576d <alltraps>
...
80105f8a:	6a 59                	push   $0x59
  jmp alltraps
80105f8c:	e9 dc f7 ff ff       	jmp    8010576d <alltraps>
...
80105f93:	6a 5a                	push   $0x5a
  jmp alltraps
80105f95:	e9 d3 f7 ff ff       	jmp    8010576d <alltraps>
...
80105f9c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f9e:	e9 ca f7 ff ff       	jmp    8010576d <alltraps>
...
80105fa5:	6a 5c                	push   $0x5c
  jmp alltraps
80105fa7:	e9 c1 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fae:	6a 5d                	push   $0x5d
  jmp alltraps
80105fb0:	e9 b8 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fb7:	6a 5e                	push   $0x5e
  jmp alltraps
80105fb9:	e9 af f7 ff ff       	jmp    8010576d <alltraps>
...
80105fc0:	6a 5f                	push   $0x5f
  jmp alltraps
80105fc2:	e9 a6 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fc9:	6a 60                	push   $0x60
  jmp alltraps
80105fcb:	e9 9d f7 ff ff       	jmp    8010576d <alltraps>
...
80105fd2:	6a 61                	push   $0x61
  jmp alltraps
80105fd4:	e9 94 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fdb:	6a 62                	push   $0x62
  jmp alltraps
80105fdd:	e9 8b f7 ff ff       	jmp    8010576d <alltraps>
...
80105fe4:	6a 63                	push   $0x63
  jmp alltraps
80105fe6:	e9 82 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fed:	6a 64                	push   $0x64
  jmp alltraps
80105fef:	e9 79 f7 ff ff       	jmp    8010576d <alltraps>
...
80105ff6:	6a 65                	push   $0x65
  jmp alltraps
80105ff8:	e9 70 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fff:	6a 66                	push   $0x66
  jmp alltraps
80106001:	e9 67 f7 ff ff       	jmp    8010576d <alltraps>
...
80106008:	6a 67                	push   $0x67
  jmp alltraps
8010600a:	e9 5e f7 ff ff       	jmp    8010576d <alltraps>
...
80106011:	6a 68                	push   $0x68
  jmp alltraps
80106013:	e9 55 f7 ff ff       	jmp    8010576d <alltraps>
...
8010601a:	6a 69                	push   $0x69
  jmp alltraps
8010601c:	e9 4c f7 ff ff       	jmp    8010576d <alltraps>
...
80106023:	6a 6a                	push   $0x6a
  jmp alltraps
80106025:	e9 43 f7 ff ff       	jmp    8010576d <alltraps>
...
8010602c:	6a 6b                	push   $0x6b
  jmp alltraps
8010602e:	e9 3a f7 ff ff       	jmp    8010576d <alltraps>
...
80106035:	6a 6c                	push   $0x6c
  jmp alltraps
80106037:	e9 31 f7 ff ff       	jmp    8010576d <alltraps>
...
8010603e:	6a 6d                	push   $0x6d
  jmp alltraps
80106040:	e9 28 f7 ff ff       	jmp    8010576d <alltraps>
...
80106047:	6a 6e                	push   $0x6e
  jmp alltraps
80106049:	e9 1f f7 ff ff       	jmp    8010576d <alltraps>
...
80106050:	6a 6f                	push   $0x6f
  jmp alltraps
80106052:	e9 16 f7 ff ff       	jmp    8010576d <alltraps>
...
80106059:	6a 70                	push   $0x70
  jmp alltraps
8010605b:	e9 0d f7 ff ff       	jmp    8010576d <alltraps>
...
80106062:	6a 71                	push   $0x71
  jmp alltraps
80106064:	e9 04 f7 ff ff       	jmp    8010576d <alltraps>
...
8010606b:	6a 72                	push   $0x72
  jmp alltraps
8010606d:	e9 fb f6 ff ff       	jmp    8010576d <alltraps>
...
80106074:	6a 73                	push   $0x73
  jmp alltraps
80106076:	e9 f2 f6 ff ff       	jmp    8010576d <alltraps>
...
8010607d:	6a 74                	push   $0x74
  jmp alltraps
8010607f:	e9 e9 f6 ff ff       	jmp    8010576d <alltraps>
...
80106086:	6a 75                	push   $0x75
  jmp alltraps
80106088:	e9 e0 f6 ff ff       	jmp    8010576d <alltraps>
...
8010608f:	6a 76                	push   $0x76
  jmp alltraps
80106091:	e9 d7 f6 ff ff       	jmp    8010576d <alltraps>
...
80106098:	6a 77                	push   $0x77
  jmp alltraps
8010609a:	e9 ce f6 ff ff       	jmp    8010576d <alltraps>
...
801060a1:	6a 78                	push   $0x78
  jmp alltraps
801060a3:	e9 c5 f6 ff ff       	jmp    8010576d <alltraps>
...
801060aa:	6a 79                	push   $0x79
  jmp alltraps
801060ac:	e9 bc f6 ff ff       	jmp    8010576d <alltraps>
...
801060b3:	6a 7a                	push   $0x7a
  jmp alltraps
801060b5:	e9 b3 f6 ff ff       	jmp    8010576d <alltraps>
...
801060c5:	6a 7c                	push   $0x7c
  jmp alltraps
801060c7:	e9 a1 f6 ff ff       	jmp    8010576d <alltraps>
...
801060ce:	6a 7d                	push   $0x7d
  jmp alltraps
801060d0:	e9 98 f6 ff ff       	jmp    8010576d <alltraps>
...
801060d7:	6a 7e                	push   $0x7e
  jmp alltraps
801060d9:	e9 8f f6 ff ff       	jmp    8010576d <alltraps>
...
801066b9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066be:	e9 aa f0 ff ff       	jmp    8010576d <alltraps>
...
801066c5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066ca:	e9 9e f0 ff ff       	jmp    8010576d <alltraps>
...
801066d1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801066d6:	e9 92 f0 ff ff       	jmp    8010576d <alltraps>
...
801066dd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801066e2:	e9 86 f0 ff ff       	jmp    8010576d <alltraps>
...
{
801066f8:	89 d7                	mov    %edx,%edi
  pde = &pgdir[PDX(va)];
801066fa:	c1 eb 16             	shr    $0x16,%ebx
801066fd:	8d 34 98             	lea    (%eax,%ebx,4),%esi
{
80106700:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106703:	8b 06                	mov    (%esi),%eax
80106705:	a8 01                	test   $0x1,%al
80106707:	74 27                	je     80106730 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106709:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010670e:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
  ...
  return &pgtab[PTX(va)];
80106714:	c1 ef 0a             	shr    $0xa,%edi
}
80106717:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
8010671a:	89 fa                	mov    %edi,%edx
...
80106734:	e8 87 bd ff ff       	call   801024c0 <kalloc>
...
8010674a:	e8 21 de ff ff       	call   80104570 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010674f:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106755:	83 c4 10             	add    $0x10,%esp
80106758:	83 c8 07             	or     $0x7,%eax
8010675b:	89 06                	mov    %eax,(%esi)
8010675d:	eb b5                	jmp    80106714 <walkpgdir+0x24>
8010675f:	90                   	nop
}
...
{
8010677e:	83 ec 1c             	sub    $0x1c,%esp
80106781:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106784:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80106788:	8b 7d 08             	mov    0x8(%ebp),%edi
8010678b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106790:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(;;){
...
80106796:	29 df                	sub    %ebx,%edi
80106798:	83 c8 01             	or     $0x1,%eax
8010679b:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010679e:	eb 15                	jmp    801067b5 <mappages+0x45>
    if(*pte & PTE_P)
801067a0:	f6 00 01             	testb  $0x1,(%eax)
801067a3:	75 45                	jne    801067ea <mappages+0x7a>
    *pte = pa | perm | PTE_P;
801067a5:	0b 75 dc             	or     -0x24(%ebp),%esi
    if(a == last)
801067a8:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
    *pte = pa | perm | PTE_P;
801067ab:	89 30                	mov    %esi,(%eax)
    if(a == last)
801067ad:	74 31                	je     801067e0 <mappages+0x70>
      break;
    a += PGSIZE;
...
801067c2:	e8 29 ff ff ff       	call   801066f0 <walkpgdir>
...
801067ed:	68 f0 78 10 80       	push   $0x801078f0
801067f2:	e8 99 9b ff ff       	call   80100390 <panic>
...
80106865:	e8 86 fe ff ff       	call   801066f0 <walkpgdir>
    if(!pte)
...
80106892:	68 86 72 10 80       	push   $0x80107286
...
801068a3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801068a6:	e8 d5 ce ff ff       	call   80103780 <cpuid>
...
80106930:	a1 c4 53 11 80       	mov    0x801153c4,%eax
{
...
80106959:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(p == 0)
8010695c:	85 db                	test   %ebx,%ebx
8010695e:	0f 84 cb 00 00 00    	je     80106a2f <switchuvm+0xdf>
  if(p->kstack == 0)
80106964:	8b 43 08             	mov    0x8(%ebx),%eax
80106967:	85 c0                	test   %eax,%eax
80106969:	0f 84 da 00 00 00    	je     80106a49 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010696f:	8b 43 04             	mov    0x4(%ebx),%eax
80106972:	85 c0                	test   %eax,%eax
80106974:	0f 84 c2 00 00 00    	je     80106a3c <switchuvm+0xec>
  pushcli();
8010697a:	e8 11 da ff ff       	call   80104390 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010697f:	e8 ac cd ff ff       	call   80103730 <mycpu>
80106984:	89 c6                	mov    %eax,%esi
80106986:	e8 a5 cd ff ff       	call   80103730 <mycpu>
8010698b:	89 c7                	mov    %eax,%edi
8010698d:	e8 9e cd ff ff       	call   80103730 <mycpu>
80106992:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106995:	83 c7 08             	add    $0x8,%edi
80106998:	e8 93 cd ff ff       	call   80103730 <mycpu>
...
801069ab:	66 89 96 98 00 00 00 	mov    %dx,0x98(%esi)
801069b2:	66 89 be 9a 00 00 00 	mov    %di,0x9a(%esi)
801069b9:	88 86 9f 00 00 00    	mov    %al,0x9f(%esi)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801069bf:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069c4:	83 c1 08             	add    $0x8,%ecx
801069c7:	c1 e9 10             	shr    $0x10,%ecx
801069ca:	88 8e 9c 00 00 00    	mov    %cl,0x9c(%esi)
801069d0:	b9 99 40 00 00       	mov    $0x4099,%ecx
801069d5:	66 89 8e 9d 00 00 00 	mov    %cx,0x9d(%esi)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801069dc:	be 10 00 00 00       	mov    $0x10,%esi
  mycpu()->gdt[SEG_TSS].s = 0;
801069e1:	e8 4a cd ff ff       	call   80103730 <mycpu>
801069e6:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801069ed:	e8 3e cd ff ff       	call   80103730 <mycpu>
801069f2:	66 89 70 10          	mov    %si,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801069f6:	8b 73 08             	mov    0x8(%ebx),%esi
801069f9:	e8 32 cd ff ff       	call   80103730 <mycpu>
801069fe:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106a04:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a07:	e8 24 cd ff ff       	call   80103730 <mycpu>
80106a0c:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106a10:	b8 28 00 00 00       	mov    $0x28,%eax
80106a15:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106a18:	8b 43 04             	mov    0x4(%ebx),%eax
80106a1b:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106a20:	0f 22 d8             	mov    %eax,%cr3
}
...
80106a29:	5d                   	pop    %ebp
  popcli();
80106a2a:	e9 a1 d9 ff ff       	jmp    801043d0 <popcli>
    panic("switchuvm: no process");
80106a2f:	83 ec 0c             	sub    $0xc,%esp
80106a32:	68 f6 78 10 80       	push   $0x801078f6
80106a37:	e8 54 99 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106a3c:	83 ec 0c             	sub    $0xc,%esp
80106a3f:	68 21 79 10 80       	push   $0x80107921
80106a44:	e8 47 99 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106a49:	83 ec 0c             	sub    $0xc,%esp
80106a4c:	68 0c 79 10 80       	push   $0x8010790c
80106a51:	e8 3a 99 ff ff       	call   80100390 <panic>
...
80106a7b:	77 49                	ja     80106ac6 <inituvm+0x66>
  mem = kalloc();
80106a7d:	e8 3e ba ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106a8f:	e8 dc da ff ff       	call   80104570 <memset>
...
80106aa9:	e8 c2 fc ff ff       	call   80106770 <mappages>
  memmove(mem, init, sz);
...
80106ac0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ac1:	e9 5a db ff ff       	jmp    80104620 <memmove>
    panic("inituvm: more than a page");
80106ac6:	83 ec 0c             	sub    $0xc,%esp
80106ac9:	68 35 79 10 80       	push   $0x80107935
80106ace:	e8 bd 98 ff ff       	call   80100390 <panic>
...
80106b23:	e8 c8 fb ff ff       	call   801066f0 <walkpgdir>
...
80106bae:	0f 88 8e 00 00 00    	js     80106c42 <allocuvm+0xa2>
  if(newsz < oldsz)
80106bb4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106bb7:	0f 82 93 00 00 00    	jb     80106c50 <allocuvm+0xb0>
  a = PGROUNDUP(oldsz);
...
80106bcc:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80106bcf:	0f 86 7e 00 00 00    	jbe    80106c53 <allocuvm+0xb3>
80106bd5:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106bd8:	8b 7d 08             	mov    0x8(%ebp),%edi
80106bdb:	eb 42                	jmp    80106c1f <allocuvm+0x7f>
80106bdd:	8d 76 00             	lea    0x0(%esi),%esi
    memset(mem, 0, PGSIZE);
80106be0:	83 ec 04             	sub    $0x4,%esp
80106be3:	68 00 10 00 00       	push   $0x1000
80106be8:	6a 00                	push   $0x0
80106bea:	50                   	push   %eax
80106beb:	e8 80 d9 ff ff       	call   80104570 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106bf0:	58                   	pop    %eax
80106bf1:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106bf7:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106bfc:	5a                   	pop    %edx
80106bfd:	6a 06                	push   $0x6
80106bff:	50                   	push   %eax
80106c00:	89 da                	mov    %ebx,%edx
80106c02:	89 f8                	mov    %edi,%eax
80106c04:	e8 67 fb ff ff       	call   80106770 <mappages>
80106c09:	83 c4 10             	add    $0x10,%esp
80106c0c:	85 c0                	test   %eax,%eax
80106c0e:	78 50                	js     80106c60 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80106c10:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c16:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80106c19:	0f 86 81 00 00 00    	jbe    80106ca0 <allocuvm+0x100>
    mem = kalloc();
80106c1f:	e8 9c b8 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
80106c24:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106c26:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106c28:	75 b6                	jne    80106be0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106c2a:	83 ec 0c             	sub    $0xc,%esp
80106c2d:	68 6d 79 10 80       	push   $0x8010796d
80106c32:	e8 29 9a ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106c37:	83 c4 10             	add    $0x10,%esp
80106c3a:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c3d:	39 45 10             	cmp    %eax,0x10(%ebp)
80106c40:	77 6e                	ja     80106cb0 <allocuvm+0x110>
}
80106c42:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106c45:	31 ff                	xor    %edi,%edi
}
...
80106c76:	76 0d                	jbe    80106c85 <allocuvm+0xe5>
80106c78:	89 c1                	mov    %eax,%ecx
80106c7a:	8b 55 10             	mov    0x10(%ebp),%edx
80106c7d:	8b 45 08             	mov    0x8(%ebp),%eax
80106c80:	e8 7b fb ff ff       	call   80106800 <deallocuvm.part.0>
      kfree(mem);
...
80106c8b:	e8 80 b6 ff ff       	call   80102310 <kfree>
      return 0;
...
80106cba:	e8 41 fb ff ff       	call   80106800 <deallocuvm.part.0>
80106cbf:	eb 92                	jmp    80106c53 <allocuvm+0xb3>
...
80106ce0:	5d                   	pop    %ebp
80106ce1:	e9 1a fb ff ff       	jmp    80106800 <deallocuvm.part.0>
...
80106d19:	e8 e2 fa ff ff       	call   80106800 <deallocuvm.part.0>
...
80106d4e:	e8 bd b5 ff ff       	call   80102310 <kfree>
...
80106d63:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106d64:	e9 a7 b5 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106d69:	83 ec 0c             	sub    $0xc,%esp
80106d6c:	68 a1 79 10 80       	push   $0x801079a1
...
80106d85:	e8 36 b7 ff ff       	call   801024c0 <kalloc>
...
80106dbb:	e8 b0 f9 ff ff       	call   80106770 <mappages>
...
80106e0b:	a3 c4 53 11 80       	mov    %eax,0x801153c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e2e:	e8 bd f8 ff ff       	call   801066f0 <walkpgdir>
  if(pte == 0)
...
80106e3f:	68 b2 79 10 80       	push   $0x801079b2
...
80106e90:	e8 8b d7 ff ff       	call   80104620 <memmove>
...
80106eab:	e8 c0 f8 ff ff       	call   80106770 <mappages>
...
80106ec9:	e8 22 f8 ff ff       	call   801066f0 <walkpgdir>
...
80106ee5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106ee8:	e8 d3 b5 ff ff       	call   801024c0 <kalloc>
...
80106f4e:	e8 9d f7 ff ff       	call   801066f0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106fbf:	e8 5c d6 ff ff       	call   80104620 <memmove>
    len -= n;
    buf += n;
