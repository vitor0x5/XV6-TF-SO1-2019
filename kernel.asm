...
80100a3c:	0f 84 99 01 00 00    	je     80100bdb <exec+0x1cb>
    end_op();
    cprintf("exec: fail\n");
    return -1;
  }
...
80100ab7:	0f 84 96 02 00 00    	je     80100d53 <exec+0x343>
  sz = PGSIZE - 1; //starts at the second page
80100abd:	bf ff 0f 00 00       	mov    $0xfff,%edi
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
80100ac2:	31 f6                	xor    %esi,%esi
80100ac4:	e9 81 00 00 00       	jmp    80100b4a <exec+0x13a>
...
80100af8:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100afe:	e8 0d 61 00 00       	call   80106c10 <allocuvm>
...
80100b30:	e8 1b 60 00 00       	call   80106b50 <loaduvm>
...
80100b51:	03 85 ec fe ff ff    	add    -0x114(%ebp),%eax
80100b57:	50                   	push   %eax
80100b58:	8d 85 04 ff ff ff    	lea    -0xfc(%ebp),%eax
80100b5e:	50                   	push   %eax
80100b5f:	53                   	push   %ebx
80100b60:	e8 0b 0e 00 00       	call   80101970 <readi>
...
80100b74:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100b7a:	e8 f1 61 00 00       	call   80106d70 <freevm>
80100b7f:	83 c4 10             	add    $0x10,%esp
80100b82:	e9 df fe ff ff       	jmp    80100a66 <exec+0x56>
...
80100b9d:	e8 7e 0d 00 00       	call   80101920 <iunlockput>
  end_op();
80100ba2:	e8 79 20 00 00       	call   80102c20 <end_op>
  if((sz = allocuvm(pgdir, sz, sz + 2*PGSIZE)) == 0)
80100ba7:	83 c4 0c             	add    $0xc,%esp
80100baa:	56                   	push   %esi
80100bab:	57                   	push   %edi
80100bac:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100bb2:	e8 59 60 00 00       	call   80106c10 <allocuvm>
...
80100bc3:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100bc9:	e8 a2 61 00 00       	call   80106d70 <freevm>
80100bce:	83 c4 10             	add    $0x10,%esp
  return -1;
80100bd1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100bd6:	e9 a1 fe ff ff       	jmp    80100a7c <exec+0x6c>
    end_op();
80100bdb:	e8 40 20 00 00       	call   80102c20 <end_op>
    cprintf("exec: fail\n");
80100be0:	83 ec 0c             	sub    $0xc,%esp
80100be3:	68 01 71 10 80       	push   $0x80107101
80100be8:	e8 73 fa ff ff       	call   80100660 <cprintf>
    return -1;
80100bed:	83 c4 10             	add    $0x10,%esp
80100bf0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100bf5:	e9 82 fe ff ff       	jmp    80100a7c <exec+0x6c>
...
80100c08:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100c0e:	e8 7d 62 00 00       	call   80106e90 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c2b:	8b b5 f0 fe ff ff    	mov    -0x110(%ebp),%esi
...
80100c41:	e8 5a 3b 00 00       	call   801047a0 <strlen>
...
80100c54:	e8 47 3b 00 00       	call   801047a0 <strlen>
...
80100c65:	e8 76 63 00 00       	call   80106fe0 <copyout>
...
80100cc3:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100cc9:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ccf:	e8 0c 63 00 00       	call   80106fe0 <copyout>
...
80100d0e:	83 c0 6c             	add    $0x6c,%eax
80100d11:	50                   	push   %eax
80100d12:	e8 49 3a 00 00       	call   80104760 <safestrcpy>
  curproc->pgdir = pgdir;
80100d17:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
  oldpgdir = curproc->pgdir;
80100d1d:	89 f9                	mov    %edi,%ecx
80100d1f:	8b 7f 04             	mov    0x4(%edi),%edi
  curproc->tf->eip = elf.entry;  // main
80100d22:	8b 41 18             	mov    0x18(%ecx),%eax
  curproc->sz = sz;
80100d25:	89 31                	mov    %esi,(%ecx)
  curproc->pgdir = pgdir;
80100d27:	89 51 04             	mov    %edx,0x4(%ecx)
  curproc->tf->eip = elf.entry;  // main
80100d2a:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d30:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d33:	8b 41 18             	mov    0x18(%ecx),%eax
80100d36:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d39:	89 0c 24             	mov    %ecx,(%esp)
80100d3c:	e8 7f 5c 00 00       	call   801069c0 <switchuvm>
  freevm(oldpgdir);
80100d41:	89 3c 24             	mov    %edi,(%esp)
80100d44:	e8 27 60 00 00       	call   80106d70 <freevm>
  return 0;
80100d49:	83 c4 10             	add    $0x10,%esp
80100d4c:	31 c0                	xor    %eax,%eax
80100d4e:	e9 29 fd ff ff       	jmp    80100a7c <exec+0x6c>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
80100d53:	bf 00 10 00 00       	mov    $0x1000,%edi
80100d58:	be 00 30 00 00       	mov    $0x3000,%esi
80100d5d:	e9 37 fe ff ff       	jmp    80100b99 <exec+0x189>
80100d62:	66 90                	xchg   %ax,%ax
80100d64:	66 90                	xchg   %ax,%ax
...
80100d76:	68 0d 71 10 80       	push   $0x8010710d
80100d7b:	68 c0 ff 10 80       	push   $0x8010ffc0
80100d80:	e8 ab 35 00 00       	call   80104330 <initlock>
}
...
80100da1:	e8 ca 36 00 00       	call   80104470 <acquire>
...
80100dd1:	e8 5a 37 00 00       	call   80104530 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dea:	e8 41 37 00 00       	call   80104530 <release>
}
...
80100e0f:	e8 5c 36 00 00       	call   80104470 <acquire>
  if(f->ref < 1)
...
80100e2c:	e8 ff 36 00 00       	call   80104530 <release>
  return f;
}
...
80100e3b:	68 14 71 10 80       	push   $0x80107114
...
80100e61:	e8 0a 36 00 00       	call   80104470 <acquire>
  if(f->ref < 1)
...
80100e8b:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e8c:	e9 9f 36 00 00       	jmp    80104530 <release>
...
80100eb5:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100eb8:	e8 73 36 00 00       	call   80104530 <release>
  if(ff.type == FD_PIPE)
...
80100ee1:	e8 6a 24 00 00       	call   80103350 <pipeclose>
80100ee6:	83 c4 10             	add    $0x10,%esp
80100ee9:	eb df                	jmp    80100eca <fileclose+0x7a>
80100eeb:	90                   	nop
80100eec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    begin_op();
80100ef0:	e8 bb 1c 00 00       	call   80102bb0 <begin_op>
    iput(ff.ip);
...
80100f09:	5d                   	pop    %ebp
    end_op();
80100f0a:	e9 11 1d 00 00       	jmp    80102c20 <end_op>
    panic("fileclose");
80100f0f:	83 ec 0c             	sub    $0xc,%esp
80100f12:	68 1c 71 10 80       	push   $0x8010711c
...
80100fdc:	5d                   	pop    %ebp
    return piperead(f->pipe, addr, n);
80100fdd:	e9 1e 25 00 00       	jmp    80103500 <piperead>
...
80100ff2:	68 26 71 10 80       	push   $0x80107126
...
80101054:	e8 17 07 00 00       	call   80101770 <iunlock>
      end_op();
80101059:	e8 c2 1b 00 00       	call   80102c20 <end_op>
...
80101083:	0f 4f d8             	cmovg  %eax,%ebx
      begin_op();
80101086:	e8 25 1b 00 00       	call   80102bb0 <begin_op>
      ilock(f->ip);
...
801010b8:	e8 b3 06 00 00       	call   80101770 <iunlock>
      end_op();
801010bd:	e8 5e 1b 00 00       	call   80102c20 <end_op>
      if(r < 0)
...
801010fc:	5d                   	pop    %ebp
    return pipewrite(f->pipe, addr, n);
801010fd:	e9 ee 22 00 00       	jmp    801033f0 <pipewrite>
        panic("short filewrite");
80101102:	83 ec 0c             	sub    $0xc,%esp
80101105:	68 2f 71 10 80       	push   $0x8010712f
8010110a:	e8 81 f2 ff ff       	call   80100390 <panic>
  panic("filewrite");
8010110f:	83 ec 0c             	sub    $0xc,%esp
80101112:	68 35 71 10 80       	push   $0x80107135
...
80101169:	e8 12 1c 00 00       	call   80102d80 <log_write>
  brelse(bp);
...
80101183:	68 3f 71 10 80       	push   $0x8010713f
...
80101234:	68 52 71 10 80       	push   $0x80107152
...
8010124d:	e8 2e 1b 00 00       	call   80102d80 <log_write>
        brelse(bp);
...
80101275:	e8 06 33 00 00       	call   80104580 <memset>
  log_write(bp);
8010127a:	89 1c 24             	mov    %ebx,(%esp)
8010127d:	e8 fe 1a 00 00       	call   80102d80 <log_write>
  brelse(bp);
...
801012ba:	e8 b1 31 00 00       	call   80104470 <acquire>
...
8010131f:	e8 0c 32 00 00       	call   80104530 <release>
...
8010134a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010134d:	e8 de 31 00 00       	call   80104530 <release>
      return ip;
...
80101362:	68 68 71 10 80       	push   $0x80107168
...
801013de:	e8 9d 19 00 00       	call   80102d80 <log_write>
...
80101437:	68 78 71 10 80       	push   $0x80107178
...
80101471:	e8 ba 31 00 00       	call   80104630 <memmove>
  brelse(bp);
...
80101ed8:	68 ee 77 10 80       	push   $0x801077ee
...
80102332:	81 fb c8 73 11 80    	cmp    $0x801173c8,%ebx
...
80102b30:	e8 1b e9 ff ff       	call   80101450 <readsb>
  log.size = sb.nlog;
...
80102e72:	e8 b9 29 00 00       	call   80105830 <idtinit>
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 05 3b 00 00       	call   801069a0 <switchkvm>
  seginit();
80102e9b:	e8 70 3a 00 00       	call   80106910 <seginit>
  lapicinit();
...
80102ec7:	68 c8 73 11 80       	push   $0x801173c8
80102ecc:	e8 2f f5 ff ff       	call   80102400 <kinit1>
  kvmalloc();      // kernel page table
80102ed1:	e8 9a 3f 00 00       	call   80106e70 <kvmalloc>
  mpinit();        // detect other processors
80102ed6:	e8 75 01 00 00       	call   80103050 <mpinit>
  lapicinit();     // interrupt controller
80102edb:	e8 60 f7 ff ff       	call   80102640 <lapicinit>
  seginit();       // segment descriptors
80102ee0:	e8 2b 3a 00 00       	call   80106910 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 e7 2c 00 00       	call   80105be0 <uartinit>
  pinit();         // process table
80102ef9:	e8 52 08 00 00       	call   80103750 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 ad 28 00 00       	call   801057b0 <tvinit>
  binit();         // buffer cache
...
801031fb:	68 7d 75 10 80       	push   $0x8010757d
80103200:	e8 8b d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
80103205:	83 ec 0c             	sub    $0xc,%esp
80103208:	68 9c 75 10 80       	push   $0x8010759c
...
8010325b:	e8 30 db ff ff       	call   80100d90 <filealloc>
80103260:	85 c0                	test   %eax,%eax
80103262:	89 03                	mov    %eax,(%ebx)
80103264:	74 22                	je     80103288 <pipealloc+0x48>
80103266:	e8 25 db ff ff       	call   80100d90 <filealloc>
...
80103292:	e8 b9 db ff ff       	call   80100e50 <fileclose>
...
801032ba:	e8 91 db ff ff       	call   80100e50 <fileclose>
  if(*f1)
...
8010337f:	e8 2c 0c 00 00       	call   80103fb0 <wakeup>
...
801033c4:	e8 e7 0b 00 00       	call   80103fb0 <wakeup>
...
80103454:	e8 57 0b 00 00       	call   80103fb0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103459:	5a                   	pop    %edx
8010345a:	59                   	pop    %ecx
...
801034e3:	e8 c8 0a 00 00       	call   80103fb0 <wakeup>
  release(&p->lock);
...
801035d7:	e8 d4 09 00 00       	call   80103fb0 <wakeup>
  release(&p->lock);
...
8010361c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103620:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80103626:	81 fb 74 6b 11 80    	cmp    $0x80116b74,%ebx
...
80103641:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->running_t = 0;
80103648:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
8010364f:	00 00 00 
  p->waiting_t = 0;
80103652:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103659:	00 00 00 
  p->pidtimes = 0;  //aux to syscalls runtime() waittime() e turntime()
8010365c:	c7 83 08 01 00 00 00 	movl   $0x0,0x108(%ebx)
80103663:	00 00 00 
  p->pid = nextpid++;
80103666:	8d 50 01             	lea    0x1(%eax),%edx
80103669:	89 43 10             	mov    %eax,0x10(%ebx)
  p->ctime = ticks; //stores the initial time till the process is kill
8010366c:	a1 c0 73 11 80       	mov    0x801173c0,%eax
  p->pid = nextpid++;
80103671:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  p->ctime = ticks; //stores the initial time till the process is kill
80103677:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  release(&ptable.lock);
8010367d:	68 40 28 11 80       	push   $0x80112840
80103682:	e8 a9 0e 00 00       	call   80104530 <release>
...
80103694:	74 53                	je     801036e9 <allocproc+0xe9>
    return 0;
  }
...
801036a4:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801036a7:	c7 40 14 a1 57 10 80 	movl   $0x801057a1,0x14(%eax)
  p->context = (struct context*)sp;
...
801036b6:	e8 c5 0e 00 00       	call   80104580 <memset>
...
801036d3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036d5:	68 40 28 11 80       	push   $0x80112840
801036da:	e8 51 0e 00 00       	call   80104530 <release>
}
...
801036f2:	eb d4                	jmp    801036c8 <allocproc+0xc8>
...
80103703:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103706:	68 40 28 11 80       	push   $0x80112840
8010370b:	e8 20 0e 00 00       	call   80104530 <release>
...
80103756:	68 d5 75 10 80       	push   $0x801075d5
8010375b:	68 40 28 11 80       	push   $0x80112840
80103760:	e8 cb 0b 00 00       	call   80104330 <initlock>
}
...
8010377b:	75 32                	jne    801037af <mycpu+0x3f>
  apicid = lapicid();
8010377d:	e8 be ef ff ff       	call   80102740 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103782:	8b 15 30 28 11 80    	mov    0x80112830,%edx
80103788:	85 d2                	test   %edx,%edx
8010378a:	7e 0b                	jle    80103797 <mycpu+0x27>
    if (cpus[i].apicid == apicid)
8010378c:	0f b6 15 80 27 11 80 	movzbl 0x80112780,%edx
...
801037b2:	68 b8 76 10 80       	push   $0x801076b8
...
80103823:	e8 c8 35 00 00       	call   80106df0 <setupkvm>
80103828:	85 c0                	test   %eax,%eax
8010382a:	89 43 04             	mov    %eax,0x4(%ebx)
8010382d:	0f 84 cf 00 00 00    	je     80103902 <userinit+0xf2>
...
80103841:	e8 8a 32 00 00       	call   80106ad0 <inituvm>
  p->sz = PGSIZE;
80103846:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  p->ctime = ticks;
8010384c:	a1 c0 73 11 80       	mov    0x801173c0,%eax
  memset(p->tf, 0, sizeof(*p->tf));
80103851:	83 c4 0c             	add    $0xc,%esp
  p->ctime = ticks;
80103854:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
8010385a:	6a 4c                	push   $0x4c
8010385c:	6a 00                	push   $0x0
8010385e:	ff 73 18             	pushl  0x18(%ebx)
80103861:	e8 1a 0d 00 00       	call   80104580 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103866:	8b 43 18             	mov    0x18(%ebx),%eax
80103869:	ba 1b 00 00 00       	mov    $0x1b,%edx
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010386e:	b9 23 00 00 00       	mov    $0x23,%ecx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103873:	83 c4 0c             	add    $0xc,%esp
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103876:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010387a:	8b 43 18             	mov    0x18(%ebx),%eax
8010387d:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103881:	8b 43 18             	mov    0x18(%ebx),%eax
80103884:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103888:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
8010388c:	8b 43 18             	mov    0x18(%ebx),%eax
8010388f:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103893:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103897:	8b 43 18             	mov    0x18(%ebx),%eax
8010389a:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
801038a1:	8b 43 18             	mov    0x18(%ebx),%eax
801038a4:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801038ab:	8b 43 18             	mov    0x18(%ebx),%eax
801038ae:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
801038b5:	8d 43 6c             	lea    0x6c(%ebx),%eax
  p->slot = 0;
801038b8:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  safestrcpy(p->name, "initcode", sizeof(p->name));
801038bf:	6a 10                	push   $0x10
801038c1:	68 05 76 10 80       	push   $0x80107605
801038c6:	50                   	push   %eax
801038c7:	e8 94 0e 00 00       	call   80104760 <safestrcpy>
  p->cwd = namei("/");
801038cc:	c7 04 24 0e 76 10 80 	movl   $0x8010760e,(%esp)
801038d3:	e8 18 e6 ff ff       	call   80101ef0 <namei>
801038d8:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801038db:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
801038e2:	e8 89 0b 00 00       	call   80104470 <acquire>
  p->state = RUNNABLE;
801038e7:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801038ee:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
801038f5:	e8 36 0c 00 00       	call   80104530 <release>
}
...
80103905:	68 ec 75 10 80       	push   $0x801075ec
8010390a:	e8 81 ca ff ff       	call   80100390 <panic>
8010390f:	90                   	nop
...
80103918:	e8 83 0a 00 00       	call   801043a0 <pushcli>
  c = mycpu();
8010391d:	e8 4e fe ff ff       	call   80103770 <mycpu>
  p = c->proc;
...
8010393c:	e8 7f 30 00 00       	call   801069c0 <switchuvm>
  return 0;
...
8010395a:	e8 b1 32 00 00       	call   80106c10 <allocuvm>
...
8010397a:	e8 c1 33 00 00       	call   80106d40 <deallocuvm>
...
80103999:	e8 02 0a 00 00       	call   801043a0 <pushcli>
  c = mycpu();
8010399e:	e8 cd fd ff ff       	call   80103770 <mycpu>
  p = c->proc;
...
80103a0c:	e8 ef d3 ff ff       	call   80100e00 <filedup>
...
80103a46:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a49:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
80103a50:	e8 1b 0a 00 00       	call   80104470 <acquire>
  np->state = RUNNABLE;
80103a55:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a5c:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
...
80103ab6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103ab9:	e8 b2 fc ff ff       	call   80103770 <mycpu>
...
80103ad1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ad4:	bb 74 28 11 80       	mov    $0x80112874,%ebx
    acquire(&ptable.lock);
80103ad9:	68 40 28 11 80       	push   $0x80112840
...
80103b00:	e8 bb 2e 00 00       	call   801069c0 <switchuvm>
...
80103b12:	e8 a4 0c 00 00       	call   801047bb <swtch>
      switchkvm();
80103b17:	e8 84 2e 00 00       	call   801069a0 <switchkvm>
      c->proc = 0;
80103b1c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b23:	00 00 00 
80103b26:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b29:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80103b2f:	81 fb 74 6b 11 80    	cmp    $0x80116b74,%ebx
80103b35:	72 b9                	jb     80103af0 <scheduler+0x40>
    release(&ptable.lock);
80103b37:	83 ec 0c             	sub    $0xc,%esp
80103b3a:	68 40 28 11 80       	push   $0x80112840
80103b3f:	e8 ec 09 00 00       	call   80104530 <release>
    sti();
...
80103b55:	e8 46 08 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103b5a:	e8 11 fc ff ff       	call   80103770 <mycpu>
  p = c->proc;
...
80103b6d:	68 40 28 11 80       	push   $0x80112840
...
80103ba1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103ba7:	e8 c4 fb ff ff       	call   80103770 <mycpu>
...
80103bb3:	e8 03 0c 00 00       	call   801047bb <swtch>
  mycpu()->intena = intena;
80103bb8:	e8 b3 fb ff ff       	call   80103770 <mycpu>
}
...
80103c34:	8d 73 28             	lea    0x28(%ebx),%esi
80103c37:	8d 7b 68             	lea    0x68(%ebx),%edi
80103c3a:	0f 84 39 01 00 00    	je     80103d79 <exit+0x169>
    if(curproc->ofile[fd]){
80103c40:	8b 06                	mov    (%esi),%eax
80103c42:	85 c0                	test   %eax,%eax
80103c44:	74 12                	je     80103c58 <exit+0x48>
      fileclose(curproc->ofile[fd]);
80103c46:	83 ec 0c             	sub    $0xc,%esp
80103c49:	50                   	push   %eax
80103c4a:	e8 01 d2 ff ff       	call   80100e50 <fileclose>
      curproc->ofile[fd] = 0;
80103c4f:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80103c55:	83 c4 10             	add    $0x10,%esp
80103c58:	83 c6 04             	add    $0x4,%esi
  for(fd = 0; fd < NOFILE; fd++){
80103c5b:	39 fe                	cmp    %edi,%esi
80103c5d:	75 e1                	jne    80103c40 <exit+0x30>
  begin_op();
80103c5f:	e8 4c ef ff ff       	call   80102bb0 <begin_op>
  iput(curproc->cwd);
80103c64:	83 ec 0c             	sub    $0xc,%esp
80103c67:	ff 73 68             	pushl  0x68(%ebx)
80103c6a:	e8 51 db ff ff       	call   801017c0 <iput>
  end_op();
80103c6f:	e8 ac ef ff ff       	call   80102c20 <end_op>
  curproc->cwd = 0;
80103c74:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103c7b:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
80103c82:	e8 e9 07 00 00       	call   80104470 <acquire>
  wakeup1(curproc->parent);
80103c87:	8b 53 14             	mov    0x14(%ebx),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c8d:	b8 74 28 11 80       	mov    $0x80112874,%eax
80103c92:	eb 10                	jmp    80103ca4 <exit+0x94>
80103c94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103c98:	05 0c 01 00 00       	add    $0x10c,%eax
80103c9d:	3d 74 6b 11 80       	cmp    $0x80116b74,%eax
...
80103caf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cb6:	05 0c 01 00 00       	add    $0x10c,%eax
80103cbb:	3d 74 6b 11 80       	cmp    $0x80116b74,%eax
80103cc0:	72 e2                	jb     80103ca4 <exit+0x94>
      p->parent = initproc;
80103cc2:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc8:	ba 74 28 11 80       	mov    $0x80112874,%edx
80103ccd:	eb 14                	jmp    80103ce3 <exit+0xd3>
80103ccf:	90                   	nop
    if(p->parent == curproc){
80103cd0:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103cd3:	74 51                	je     80103d26 <exit+0x116>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd5:	81 c2 0c 01 00 00    	add    $0x10c,%edx
80103cdb:	81 fa 74 6b 11 80    	cmp    $0x80116b74,%edx
80103ce1:	73 7d                	jae    80103d60 <exit+0x150>
    if(curproc->parent == p){ //saves the exec times from this process on the parent struct
80103ce3:	39 53 14             	cmp    %edx,0x14(%ebx)
80103ce6:	75 e8                	jne    80103cd0 <exit+0xc0>
      p->pwaiting_t[curproc->pid - p->pid - 1] = curproc->waiting_t;
80103ce8:	8b 42 10             	mov    0x10(%edx),%eax
80103ceb:	8b 73 10             	mov    0x10(%ebx),%esi
80103cee:	8b bb 84 00 00 00    	mov    0x84(%ebx),%edi
80103cf4:	29 c6                	sub    %eax,%esi
80103cf6:	89 bc b2 8c 00 00 00 	mov    %edi,0x8c(%edx,%esi,4)
      p->prunning_t[curproc->pid - p->pid - 1] = curproc->running_t;
80103cfd:	8b 73 10             	mov    0x10(%ebx),%esi
80103d00:	8b bb 88 00 00 00    	mov    0x88(%ebx),%edi
80103d06:	29 c6                	sub    %eax,%esi
80103d08:	89 bc b2 b4 00 00 00 	mov    %edi,0xb4(%edx,%esi,4)
      p->pturnaround_t[curproc->pid - p->pid - 1] = curproc->turnaround_t;
80103d0f:	8b 7b 10             	mov    0x10(%ebx),%edi
80103d12:	8b b3 8c 00 00 00    	mov    0x8c(%ebx),%esi
80103d18:	29 c7                	sub    %eax,%edi
80103d1a:	89 b4 ba dc 00 00 00 	mov    %esi,0xdc(%edx,%edi,4)
    if(p->parent == curproc){
80103d21:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103d24:	75 af                	jne    80103cd5 <exit+0xc5>
      if(p->state == ZOMBIE)
80103d26:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103d2a:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103d2d:	75 a6                	jne    80103cd5 <exit+0xc5>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d2f:	b8 74 28 11 80       	mov    $0x80112874,%eax
80103d34:	eb 16                	jmp    80103d4c <exit+0x13c>
80103d36:	8d 76 00             	lea    0x0(%esi),%esi
80103d39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80103d40:	05 0c 01 00 00       	add    $0x10c,%eax
80103d45:	3d 74 6b 11 80       	cmp    $0x80116b74,%eax
80103d4a:	73 89                	jae    80103cd5 <exit+0xc5>
    if(p->state == SLEEPING && p->chan == chan)
80103d4c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103d50:	75 ee                	jne    80103d40 <exit+0x130>
80103d52:	3b 48 20             	cmp    0x20(%eax),%ecx
80103d55:	75 e9                	jne    80103d40 <exit+0x130>
      p->state = RUNNABLE;
80103d57:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103d5e:	eb e0                	jmp    80103d40 <exit+0x130>
  curproc->state = ZOMBIE;
80103d60:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103d67:	e8 e4 fd ff ff       	call   80103b50 <sched>
  panic("zombie exit");
80103d6c:	83 ec 0c             	sub    $0xc,%esp
80103d6f:	68 5d 76 10 80       	push   $0x8010765d
80103d74:	e8 17 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d79:	83 ec 0c             	sub    $0xc,%esp
80103d7c:	68 50 76 10 80       	push   $0x80107650
...
80103d97:	68 40 28 11 80       	push   $0x80112840
80103d9c:	e8 cf 06 00 00       	call   80104470 <acquire>
  pushcli();
80103da1:	e8 fa 05 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103da6:	e8 c5 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103dab:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103db1:	e8 2a 06 00 00       	call   801043e0 <popcli>
  myproc()->state = RUNNABLE;
80103db6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103dbd:	e8 8e fd ff ff       	call   80103b50 <sched>
  release(&ptable.lock);
80103dc2:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
80103dc9:	e8 62 07 00 00       	call   80104530 <release>
}
...
80103dec:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103def:	e8 ac 05 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103df4:	e8 77 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103df9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dff:	e8 dc 05 00 00       	call   801043e0 <popcli>
  if(p == 0)
...
80103e10:	81 fe 40 28 11 80    	cmp    $0x80112840,%esi
80103e16:	74 50                	je     80103e68 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103e18:	83 ec 0c             	sub    $0xc,%esp
80103e1b:	68 40 28 11 80       	push   $0x80112840
80103e20:	e8 4b 06 00 00       	call   80104470 <acquire>
    release(lk);
80103e25:	89 34 24             	mov    %esi,(%esp)
80103e28:	e8 03 07 00 00       	call   80104530 <release>
  p->chan = chan;
80103e2d:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103e30:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103e37:	e8 14 fd ff ff       	call   80103b50 <sched>
  p->chan = 0;
80103e3c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103e43:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
80103e4a:	e8 e1 06 00 00       	call   80104530 <release>
    acquire(lk);
...
80103e5b:	5d                   	pop    %ebp
    acquire(lk);
80103e5c:	e9 0f 06 00 00       	jmp    80104470 <acquire>
...
80103e6b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103e72:	e8 d9 fc ff ff       	call   80103b50 <sched>
  p->chan = 0;
...
80103e89:	68 6f 76 10 80       	push   $0x8010766f
80103e8e:	e8 fd c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e93:	83 ec 0c             	sub    $0xc,%esp
80103e96:	68 69 76 10 80       	push   $0x80107669
...
80103ea4:	53                   	push   %ebx
  pushcli();
80103ea5:	e8 f6 04 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103eaa:	e8 c1 f8 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103eaf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103eb5:	e8 26 05 00 00       	call   801043e0 <popcli>
  acquire(&ptable.lock);
80103eba:	83 ec 0c             	sub    $0xc,%esp
80103ebd:	68 40 28 11 80       	push   $0x80112840
80103ec2:	e8 a9 05 00 00       	call   80104470 <acquire>
80103ec7:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103eca:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ecc:	bb 74 28 11 80       	mov    $0x80112874,%ebx
80103ed1:	eb 13                	jmp    80103ee6 <wait+0x46>
80103ed3:	90                   	nop
80103ed4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ed8:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80103ede:	81 fb 74 6b 11 80    	cmp    $0x80116b74,%ebx
...
80103eef:	74 3f                	je     80103f30 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ef1:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
      havekids = 1;
80103ef7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103efc:	81 fb 74 6b 11 80    	cmp    $0x80116b74,%ebx
80103f02:	72 e2                	jb     80103ee6 <wait+0x46>
    if(!havekids || curproc->killed){
80103f04:	85 c0                	test   %eax,%eax
80103f06:	0f 84 84 00 00 00    	je     80103f90 <wait+0xf0>
80103f0c:	8b 46 24             	mov    0x24(%esi),%eax
80103f0f:	85 c0                	test   %eax,%eax
80103f11:	75 7d                	jne    80103f90 <wait+0xf0>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103f13:	83 ec 08             	sub    $0x8,%esp
80103f16:	68 40 28 11 80       	push   $0x80112840
...
80103f42:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f49:	e8 22 2e 00 00       	call   80106d70 <freevm>
        release(&ptable.lock);
80103f4e:	c7 04 24 40 28 11 80 	movl   $0x80112840,(%esp)
        p->pid = 0;
...
80103f67:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->ctime = 0;
80103f6e:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
80103f75:	00 00 00 
        p->state = UNUSED;
80103f78:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f7f:	e8 ac 05 00 00       	call   80104530 <release>
        return pid;
80103f84:	83 c4 10             	add    $0x10,%esp
}
80103f87:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80103f90:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80103f93:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f98:	68 40 28 11 80       	push   $0x80112840
80103f9d:	e8 8e 05 00 00       	call   80104530 <release>
      return -1;
80103fa2:	83 c4 10             	add    $0x10,%esp
80103fa5:	eb e0                	jmp    80103f87 <wait+0xe7>
...
80103fb7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103fba:	68 40 28 11 80       	push   $0x80112840
80103fbf:	e8 ac 04 00 00       	call   80104470 <acquire>
80103fc4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fc7:	b8 74 28 11 80       	mov    $0x80112874,%eax
80103fcc:	eb 0e                	jmp    80103fdc <wakeup+0x2c>
80103fce:	66 90                	xchg   %ax,%ax
80103fd0:	05 0c 01 00 00       	add    $0x10c,%eax
80103fd5:	3d 74 6b 11 80       	cmp    $0x80116b74,%eax
...
80103fe7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fee:	05 0c 01 00 00       	add    $0x10c,%eax
80103ff3:	3d 74 6b 11 80       	cmp    $0x80116b74,%eax
80103ff8:	72 e2                	jb     80103fdc <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
80103ffa:	c7 45 08 40 28 11 80 	movl   $0x80112840,0x8(%ebp)
}
80104001:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104004:	c9                   	leave  
  release(&ptable.lock);
80104005:	e9 26 05 00 00       	jmp    80104530 <release>
...
80104017:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010401a:	68 40 28 11 80       	push   $0x80112840
8010401f:	e8 4c 04 00 00       	call   80104470 <acquire>
80104024:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104027:	b8 74 28 11 80       	mov    $0x80112874,%eax
8010402c:	eb 0e                	jmp    8010403c <kill+0x2c>
8010402e:	66 90                	xchg   %ax,%ax
80104030:	05 0c 01 00 00       	add    $0x10c,%eax
80104035:	3d 74 6b 11 80       	cmp    $0x80116b74,%eax
...
80104058:	68 40 28 11 80       	push   $0x80112840
8010405d:	e8 ce 04 00 00       	call   80104530 <release>
      return 0;
...
80104073:	68 40 28 11 80       	push   $0x80112840
80104078:	e8 b3 04 00 00       	call   80104530 <release>
  return -1;
...
80104096:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104099:	bb 74 28 11 80       	mov    $0x80112874,%ebx
{
...
801040ab:	68 c3 79 10 80       	push   $0x801079c3
801040b0:	e8 ab c5 ff ff       	call   80100660 <cprintf>
801040b5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040b8:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
801040be:	81 fb 74 6b 11 80    	cmp    $0x80116b74,%ebx
...
801040d1:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040d4:	ba 80 76 10 80       	mov    $0x80107680,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040d9:	77 11                	ja     801040ec <procdump+0x5c>
801040db:	8b 14 85 e0 76 10 80 	mov    -0x7fef8920(,%eax,4),%edx
      state = "???";
801040e2:	b8 80 76 10 80       	mov    $0x80107680,%eax
...
801040f4:	68 84 76 10 80       	push   $0x80107684
...
8010411b:	e8 30 02 00 00       	call   80104350 <getcallerpcs>
...
80104139:	68 c1 70 10 80       	push   $0x801070c1
...
80104164:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104167:	e8 34 02 00 00       	call   801043a0 <pushcli>
  c = mycpu();
8010416c:	e8 ff f5 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80104171:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104177:	e8 64 02 00 00       	call   801043e0 <popcli>
  struct proc *p = myproc();
  int wt = p->pwaiting_t[p->pidtimes]; 
8010417c:	8b 83 08 01 00 00    	mov    0x108(%ebx),%eax
  //p->pidtimes++;  
  return wt;
80104182:	8b 84 83 90 00 00 00 	mov    0x90(%ebx,%eax,4),%eax
}
...
80104194:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104197:	e8 04 02 00 00       	call   801043a0 <pushcli>
  c = mycpu();
8010419c:	e8 cf f5 ff ff       	call   80103770 <mycpu>
  p = c->proc;
801041a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801041a7:	e8 34 02 00 00       	call   801043e0 <popcli>
  struct proc *p = myproc();
  int rt = p->prunning_t[p->pidtimes];
801041ac:	8b 83 08 01 00 00    	mov    0x108(%ebx),%eax
  //p->pidtimes++;
  return rt;
801041b2:	8b 84 83 b8 00 00 00 	mov    0xb8(%ebx,%eax,4),%eax
}
801041b9:	83 c4 04             	add    $0x4,%esp
801041bc:	5b                   	pop    %ebx
801041bd:	5d                   	pop    %ebp
801041be:	c3                   	ret    
801041bf:	90                   	nop
...
801041c4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801041c7:	e8 d4 01 00 00       	call   801043a0 <pushcli>
  c = mycpu();
801041cc:	e8 9f f5 ff ff       	call   80103770 <mycpu>
  p = c->proc;
801041d1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801041d7:	e8 04 02 00 00       	call   801043e0 <popcli>
  struct proc *p = myproc();
  int tt = p->pturnaround_t[p->pidtimes];
801041dc:	8b 93 08 01 00 00    	mov    0x108(%ebx),%edx
801041e2:	8b 84 93 e0 00 00 00 	mov    0xe0(%ebx,%edx,4),%eax
  p->pidtimes++;  //increments pidtimes to take the waiting time of other son in the next call
801041e9:	83 c2 01             	add    $0x1,%edx
801041ec:	89 93 08 01 00 00    	mov    %edx,0x108(%ebx)
  return tt;
}
...
8010420a:	68 f8 76 10 80       	push   $0x801076f8
...
80104265:	e8 76 fb ff ff       	call   80103de0 <sleep>
  while (lk->locked) {
...
80104273:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104279:	e8 62 f5 ff ff       	call   801037e0 <myproc>
...
801042c4:	e8 e7 fc ff ff       	call   80103fb0 <wakeup>
  release(&lk->lk);
...
801043bf:	e8 ac f3 ff ff       	call   80103770 <mycpu>
801043c4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801043ca:	e8 a1 f3 ff ff       	call   80103770 <mycpu>
...
8010440c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104410:	e8 5b f3 ff ff       	call   80103770 <mycpu>
...
80104425:	68 03 77 10 80       	push   $0x80107703
8010442a:	e8 61 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010442f:	83 ec 0c             	sub    $0xc,%esp
80104432:	68 1a 77 10 80       	push   $0x8010771a
...
80104458:	e8 13 f3 ff ff       	call   80103770 <mycpu>
...
801044b4:	e8 b7 f2 ff ff       	call   80103770 <mycpu>
...
80104517:	68 21 77 10 80       	push   $0x80107721
...
8010456c:	68 29 77 10 80       	push   $0x80107729
...
801047e1:	39 da                	cmp    %ebx,%edx
801047e3:	76 2b                	jbe    80104810 <fetchint+0x40>
801047e5:	8d 4b 04             	lea    0x4(%ebx),%ecx
801047e8:	39 ca                	cmp    %ecx,%edx
801047ea:	72 24                	jb     80104810 <fetchint+0x40>
    return -1;
  if (curproc->pid > 1 && addr < PGSIZE) {
801047ec:	83 78 10 01          	cmpl   $0x1,0x10(%eax)
801047f0:	7e 08                	jle    801047fa <fetchint+0x2a>
801047f2:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
801047f8:	76 16                	jbe    80104810 <fetchint+0x40>
	  return -1;  //ERROR: try to access the first page
  }
  *ip = *(int*)(addr);
801047fa:	8b 45 0c             	mov    0xc(%ebp),%eax
801047fd:	8b 13                	mov    (%ebx),%edx
801047ff:	89 10                	mov    %edx,(%eax)
  return 0;
80104801:	31 c0                	xor    %eax,%eax
}
80104803:	83 c4 04             	add    $0x4,%esp
80104806:	5b                   	pop    %ebx
80104807:	5d                   	pop    %ebp
80104808:	c3                   	ret    
...
80104815:	eb ec                	jmp    80104803 <fetchint+0x33>
...
80104831:	76 31                	jbe    80104864 <fetchstr+0x44>
    return -1;
  if (curproc->pid > 1 && addr < PGSIZE) {
80104833:	83 78 10 01          	cmpl   $0x1,0x10(%eax)
80104837:	7e 08                	jle    80104841 <fetchstr+0x21>
80104839:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
8010483f:	76 23                	jbe    80104864 <fetchstr+0x44>
	  return -1;  //ERROR: try to access the first page
  }
  *pp = (char*)addr;
80104841:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104844:	89 da                	mov    %ebx,%edx
80104846:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
80104848:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
8010484a:	39 c3                	cmp    %eax,%ebx
8010484c:	73 16                	jae    80104864 <fetchstr+0x44>
    if(*s == 0)
8010484e:	80 3b 00             	cmpb   $0x0,(%ebx)
80104851:	75 0a                	jne    8010485d <fetchstr+0x3d>
80104853:	eb 2b                	jmp    80104880 <fetchstr+0x60>
80104855:	8d 76 00             	lea    0x0(%esi),%esi
80104858:	80 3a 00             	cmpb   $0x0,(%edx)
8010485b:	74 13                	je     80104870 <fetchstr+0x50>
  for(s = *pp; s < ep; s++){
8010485d:	83 c2 01             	add    $0x1,%edx
80104860:	39 d0                	cmp    %edx,%eax
80104862:	77 f4                	ja     80104858 <fetchstr+0x38>
    return -1;
...
80104880:	31 c0                	xor    %eax,%eax
      return s - *pp;
80104882:	eb e5                	jmp    80104869 <fetchstr+0x49>
...
801048a0:	89 75 0c             	mov    %esi,0xc(%ebp)
801048a3:	8b 40 18             	mov    0x18(%eax),%eax
801048a6:	8b 40 44             	mov    0x44(%eax),%eax
801048a9:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
}
801048ad:	5b                   	pop    %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801048ae:	89 45 08             	mov    %eax,0x8(%ebp)
}
801048b1:	5e                   	pop    %esi
801048b2:	5d                   	pop    %ebp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801048b3:	e9 18 ff ff ff       	jmp    801047d0 <fetchint>
801048b8:	90                   	nop
...
801048dc:	e8 af ff ff ff       	call   80104890 <argint>
    return -1;
...
8010492d:	e8 5e ff ff ff       	call   80104890 <argint>
...
8010497c:	8b 14 85 60 77 10 80 	mov    -0x7fef88a0(,%eax,4),%edx
...
801049a0:	68 31 77 10 80       	push   $0x80107731
...
801049fc:	e8 bf d1 ff ff       	call   80101bc0 <dirlookup>
...
80104a0e:	e8 0d cf ff ff       	call   80101920 <iunlockput>
    ilock(ip);
80104a13:	89 3c 24             	mov    %edi,(%esp)
80104a16:	e8 75 cc ff ff       	call   80101690 <ilock>
...
80104af4:	68 e4 77 10 80       	push   $0x801077e4
...
80104b0c:	68 e3 77 10 80       	push   $0x801077e3
...
80104b25:	68 d7 77 10 80       	push   $0x801077d7
...
80104b3a:	68 e6 77 10 80       	push   $0x801077e6
80104b3f:	e8 4c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b44:	83 ec 0c             	sub    $0xc,%esp
80104b47:	68 c8 77 10 80       	push   $0x801077c8
...
80104b72:	e8 19 fd ff ff       	call   80104890 <argint>
...
80104bf2:	e8 09 c2 ff ff       	call   80100e00 <filedup>
  return fd;
...
80104c3d:	e8 4e fc ff ff       	call   80104890 <argint>
...
80104c6d:	e8 fe c2 ff ff       	call   80100f70 <fileread>
...
80104cad:	e8 de fb ff ff       	call   80104890 <argint>
...
80104cdd:	e8 1e c3 ff ff       	call   80101000 <filewrite>
...
80104d2b:	e8 20 c1 ff ff       	call   80100e50 <fileclose>
  return 0;
...
80104d84:	e8 97 c1 ff ff       	call   80100f20 <filestat>
...
80104f39:	58                   	pop    %eax
80104f3a:	5a                   	pop    %edx
80104f3b:	68 e4 77 10 80       	push   $0x801077e4
...
80104f54:	68 e3 77 10 80       	push   $0x801077e3
...
80104fae:	e8 cd f5 ff ff       	call   80104580 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
801050f8:	e8 93 f7 ff ff       	call   80104890 <argint>
...
80105146:	e8 45 bc ff ff       	call   80100d90 <filealloc>
...
8010521c:	e8 2f bc ff ff       	call   80100e50 <fileclose>
...
80105426:	e8 55 f1 ff ff       	call   80104580 <memset>
...
80105448:	e8 d3 f3 ff ff       	call   80104820 <fetchstr>
...
80105470:	e8 5b f3 ff ff       	call   801047d0 <fetchint>
...
8010557e:	e8 cd b8 ff ff       	call   80100e50 <fileclose>
    fileclose(wf);
80105583:	58                   	pop    %eax
80105584:	ff 75 e4             	pushl  -0x1c(%ebp)
80105587:	e8 c4 b8 ff ff       	call   80100e50 <fileclose>
    return -1;
...
801055c3:	5d                   	pop    %ebp
  return wait();
801055c4:	e9 d7 e8 ff ff       	jmp    80103ea0 <wait>
...
801055ee:	e8 1d ea ff ff       	call   80104010 <kill>
...
80105695:	e8 d6 ed ff ff       	call   80104470 <acquire>
  ticks0 = ticks;
...
801056bd:	e8 1e e7 ff ff       	call   80103de0 <sleep>
  while(ticks - ticks0 < n){
...
801056e5:	e8 46 ee ff ff       	call   80104530 <release>
      return -1;
...
80105708:	e8 23 ee ff ff       	call   80104530 <release>
  return 0;
...
80105763:	5d                   	pop    %ebp
  return runtime();
80105764:	e9 27 ea ff ff       	jmp    80104190 <runtime>
...
80105773:	5d                   	pop    %ebp
  return waittime();
80105774:	e9 e7 e9 ff ff       	jmp    80104160 <waittime>
...
80105783:	5d                   	pop    %ebp
  return turntime();
80105784:	e9 37 ea ff ff       	jmp    801041c0 <turntime>
...
801057fe:	00 00 ef 
  initlock(&tickslock, "time");
80105801:	68 29 78 10 80       	push   $0x80107829
...
801058bc:	e8 1f df ff ff       	call   801037e0 <myproc>
...
801058f6:	e8 e5 de ff ff       	call   801037e0 <myproc>
...
8010592a:	0f 85 10 01 00 00    	jne    80105a40 <trap+0x1e0>
    myproc()->tf = tf;
80105930:	e8 ab de ff ff       	call   801037e0 <myproc>
80105935:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105938:	e8 23 f0 ff ff       	call   80104960 <syscall>
    if(myproc()->killed)
8010593d:	e8 9e de ff ff       	call   801037e0 <myproc>
...
8010594f:	5d                   	pop    %ebp
    exit();
80105950:	e9 bb e2 ff ff       	jmp    80103c10 <exit>
...
80105970:	0f 8e aa 01 00 00    	jle    80105b20 <trap+0x2c0>
        myproc()->slot = 0;
80105976:	e8 65 de ff ff       	call   801037e0 <myproc>
8010597b:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
        yield();
80105982:	e8 09 e4 ff ff       	call   80103d90 <yield>
...
80105a07:	68 34 78 10 80       	push   $0x80107834
...
80105a56:	e8 85 dd ff ff       	call   801037e0 <myproc>
80105a5b:	2b 98 80 00 00 00    	sub    0x80(%eax),%ebx
80105a61:	e8 7a dd ff ff       	call   801037e0 <myproc>
80105a66:	89 98 8c 00 00 00    	mov    %ebx,0x8c(%eax)
    myproc()->waiting_t = myproc()->turnaround_t - myproc()->running_t;
80105a6c:	e8 6f dd ff ff       	call   801037e0 <myproc>
...
80105a9e:	e8 3d dd ff ff       	call   801037e0 <myproc>
...
80105aae:	89 b0 8c 00 00 00    	mov    %esi,0x8c(%eax)
    myproc()->waiting_t = myproc()->turnaround_t - myproc()->running_t;
80105ab4:	e8 27 dd ff ff       	call   801037e0 <myproc>
80105ab9:	8b b0 8c 00 00 00    	mov    0x8c(%eax),%esi
80105abf:	e8 1c dd ff ff       	call   801037e0 <myproc>
80105ac4:	8b b8 88 00 00 00    	mov    0x88(%eax),%edi
80105aca:	e8 11 dd ff ff       	call   801037e0 <myproc>
80105acf:	29 fe                	sub    %edi,%esi
80105ad1:	89 b0 84 00 00 00    	mov    %esi,0x84(%eax)
    exit();
80105ad7:	e8 34 e1 ff ff       	call   80103c10 <exit>
...
80105b20:	e8 bb dc ff ff       	call   801037e0 <myproc>
...
80105b37:	e8 84 dc ff ff       	call   801037c0 <cpuid>
...
80105b45:	68 58 78 10 80       	push   $0x80107858
80105b4a:	e8 11 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b4f:	83 c4 14             	add    $0x14,%esp
80105b52:	68 2e 78 10 80       	push   $0x8010782e
...
80105bb5:	e8 c6 cb ff ff       	call   80102780 <microdelay>
...
80105c4c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c4f:	bb 0c 79 10 80       	mov    $0x8010790c,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c54:	6a 00                	push   $0x0
80105c56:	6a 04                	push   $0x4
80105c58:	e8 83 c6 ff ff       	call   801022e0 <ioapicenable>
...
801067a4:	e8 27 bd ff ff       	call   801024d0 <kalloc>
...
801067ba:	e8 c1 dd ff ff       	call   80104580 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010685d:	68 14 79 10 80       	push   $0x80107914
...
801068b4:	e8 67 ba ff ff       	call   80102320 <kfree>
      *pte = 0;
...
80106902:	68 e6 72 10 80       	push   $0x801072e6
...
80106913:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106916:	e8 a5 ce ff ff       	call   801037c0 <cpuid>
...
801069e4:	0f 84 c2 00 00 00    	je     80106aac <switchuvm+0xec>
  pushcli();
801069ea:	e8 b1 d9 ff ff       	call   801043a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069ef:	e8 7c cd ff ff       	call   80103770 <mycpu>
801069f4:	89 c6                	mov    %eax,%esi
801069f6:	e8 75 cd ff ff       	call   80103770 <mycpu>
801069fb:	89 c7                	mov    %eax,%edi
801069fd:	e8 6e cd ff ff       	call   80103770 <mycpu>
80106a02:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a05:	83 c7 08             	add    $0x8,%edi
80106a08:	e8 63 cd ff ff       	call   80103770 <mycpu>
...
80106aff:	e8 7c da ff ff       	call   80104580 <memset>
...
80106b30:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b31:	e9 fa da ff ff       	jmp    80104630 <memmove>
    panic("inituvm: more than a page");
80106b36:	83 ec 0c             	sub    $0xc,%esp
80106b39:	68 59 79 10 80       	push   $0x80107959
...
80106c5b:	e8 20 d9 ff ff       	call   80104580 <memset>
...
80106c89:	0f 86 81 00 00 00    	jbe    80106d10 <allocuvm+0x100>
    mem = kalloc();
80106c8f:	e8 3c b8 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
80106c9d:	68 91 79 10 80       	push   $0x80107991
...
80106cd3:	68 a9 79 10 80       	push   $0x801079a9
...
80106dbe:	e8 5d b5 ff ff       	call   80102320 <kfree>
...
80106dd3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106dd4:	e9 47 b5 ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80106dd9:	83 ec 0c             	sub    $0xc,%esp
80106ddc:	68 c5 79 10 80       	push   $0x801079c5
...
80106df5:	e8 d6 b6 ff ff       	call   801024d0 <kalloc>
...
80106e10:	e8 6b d7 ff ff       	call   80104580 <memset>
...
80106eaf:	68 d6 79 10 80       	push   $0x801079d6
...
80106ed3:	0f 84 a0 00 00 00    	je     80106f79 <copyuvm+0xb9>
    return 0;
  for(i = PGSIZE; i < sz; i += PGSIZE){
80106ed9:	81 7d 0c 00 10 00 00 	cmpl   $0x1000,0xc(%ebp)
80106ee0:	0f 86 93 00 00 00    	jbe    80106f79 <copyuvm+0xb9>
80106ee6:	be 00 10 00 00       	mov    $0x1000,%esi
80106eeb:	eb 49                	jmp    80106f36 <copyuvm+0x76>
...
80106f01:	57                   	push   %edi
80106f02:	50                   	push   %eax
80106f03:	e8 28 d7 ff ff       	call   80104630 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106f08:	58                   	pop    %eax
80106f09:	5a                   	pop    %edx
80106f0a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106f0d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106f10:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106f15:	53                   	push   %ebx
80106f16:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106f1c:	52                   	push   %edx
80106f1d:	89 f2                	mov    %esi,%edx
80106f1f:	e8 bc f8 ff ff       	call   801067e0 <mappages>
80106f24:	83 c4 10             	add    $0x10,%esp
80106f27:	85 c0                	test   %eax,%eax
80106f29:	78 39                	js     80106f64 <copyuvm+0xa4>
  for(i = PGSIZE; i < sz; i += PGSIZE){
80106f2b:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106f31:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106f34:	76 43                	jbe    80106f79 <copyuvm+0xb9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106f36:	8b 45 08             	mov    0x8(%ebp),%eax
80106f39:	31 c9                	xor    %ecx,%ecx
80106f3b:	89 f2                	mov    %esi,%edx
80106f3d:	e8 1e f8 ff ff       	call   80106760 <walkpgdir>
80106f42:	85 c0                	test   %eax,%eax
80106f44:	74 3e                	je     80106f84 <copyuvm+0xc4>
    if(!(*pte & PTE_P))
80106f46:	8b 18                	mov    (%eax),%ebx
80106f48:	f6 c3 01             	test   $0x1,%bl
80106f4b:	74 44                	je     80106f91 <copyuvm+0xd1>
    pa = PTE_ADDR(*pte);
80106f4d:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106f4f:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
80106f55:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106f5b:	e8 70 b5 ff ff       	call   801024d0 <kalloc>
80106f60:	85 c0                	test   %eax,%eax
80106f62:	75 8c                	jne    80106ef0 <copyuvm+0x30>
    }
  }
  return d;
...
80106f67:	ff 75 e0             	pushl  -0x20(%ebp)
80106f6a:	e8 01 fe ff ff       	call   80106d70 <freevm>
  return 0;
80106f6f:	83 c4 10             	add    $0x10,%esp
80106f72:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
80106f79:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106f87:	68 e0 79 10 80       	push   $0x801079e0
80106f8c:	e8 ff 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: page not present");
80106f91:	83 ec 0c             	sub    $0xc,%esp
80106f94:	68 fa 79 10 80       	push   $0x801079fa
80106f99:	e8 f2 93 ff ff       	call   80100390 <panic>
...
80106fae:	e8 ad f7 ff ff       	call   80106760 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010701f:	e8 0c d6 ff ff       	call   80104630 <memmove>
    len -= n;
    buf += n;
