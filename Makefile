...
EXTRA=\
	...
	ln.c ls.c mkdir.c rm.c stressfs.c usertests.c wc.c zombie.c\ firstprogram.c\ FRRsanity.c\
	printf.c umalloc.c\ FCFSsanity.c\ NullPointerSanity.c\
