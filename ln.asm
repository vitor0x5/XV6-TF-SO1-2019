    ...
    1007:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
    ...
    1017:	52                   	push   %edx
    1018:	52                   	push   %edx
    1019:	68 78 17 00 00       	push   $0x1778
    101e:	6a 02                	push   $0x2
  ...
  exit();
    ...
    1049:	68 8b 17 00 00       	push   $0x178b
    104e:	6a 02                	push   $0x2
    ...
    1389:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    13b7:	f7 f1                	div    %ecx
    13b9:	0f b6 92 a8 17 00 00 	movzbl 0x17a8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15d4:	e9 8f fe ff ff       	jmp    1468 <printf+0x48>
          s = "(null)";
    15d9:	bb 9f 17 00 00       	mov    $0x179f,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15f1:	a1 50 1a 00 00       	mov    0x1a50,%eax
{
  ...
  freep = p;
    162f:	a3 50 1a 00 00       	mov    %eax,0x1a50
}
    1634:	5b                   	pop    %ebx
    1635:	5e                   	pop    %esi
    1636:	5f                   	pop    %edi
    ...
    1646:	72 ce                	jb     1616 <free+0x26>
{
  ...
  freep = p;
    166a:	a3 50 1a 00 00       	mov    %eax,0x1a50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    168c:	8b 15 50 1a 00 00    	mov    0x1a50,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16d1:	39 05 50 1a 00 00    	cmp    %eax,0x1a50
  ...
  return freep;
    16fb:	8b 15 50 1a 00 00    	mov    0x1a50,%edx
    ...
    1724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1727:	89 15 50 1a 00 00    	mov    %edx,0x1a50
}
    ...
    base.s.ptr = freep = prevp = &base;
    1740:	c7 05 50 1a 00 00 54 	movl   $0x1a54,0x1a50
    1747:	1a 00 00 
    174a:	c7 05 54 1a 00 00 54 	movl   $0x1a54,0x1a54
    1751:	1a 00 00 
    base.s.size = 0;
    1754:	b8 54 1a 00 00       	mov    $0x1a54,%eax
    1759:	c7 05 58 1a 00 00 00 	movl   $0x0,0x1a58
    1760:	00 00 00 
