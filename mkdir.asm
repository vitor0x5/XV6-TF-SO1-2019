...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    1053:	68 af 17 00 00       	push   $0x17af
    1058:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15f4:	e9 8f fe ff ff       	jmp    1488 <printf+0x48>
          s = "(null)";
    15f9:	bb cb 17 00 00       	mov    $0x17cb,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1611:	a1 84 1a 00 00       	mov    0x1a84,%eax
{
  ...
  freep = p;
    164f:	a3 84 1a 00 00       	mov    %eax,0x1a84
}
    1654:	5b                   	pop    %ebx
    1655:	5e                   	pop    %esi
    1656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16ac:	8b 15 84 1a 00 00    	mov    0x1a84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16f1:	39 05 84 1a 00 00    	cmp    %eax,0x1a84
  ...
  return freep;
    171b:	8b 15 84 1a 00 00    	mov    0x1a84,%edx
    ...
    1744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1747:	89 15 84 1a 00 00    	mov    %edx,0x1a84
}
    ...
    base.s.ptr = freep = prevp = &base;
    1760:	c7 05 84 1a 00 00 88 	movl   $0x1a88,0x1a84
    1767:	1a 00 00 
    176a:	c7 05 88 1a 00 00 88 	movl   $0x1a88,0x1a88
    1771:	1a 00 00 
    base.s.size = 0;
    1774:	b8 88 1a 00 00       	mov    $0x1a88,%eax
    1779:	c7 05 8c 1a 00 00 00 	movl   $0x0,0x1a8c
    1780:	00 00 00 
