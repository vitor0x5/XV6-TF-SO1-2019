...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    1020:	6a 02                	push   $0x2
    1022:	68 79 22 00 00       	push   $0x2279
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    1089:	68 02 22 00 00       	push   $0x2202
  ...
  exit();
    ...
    10ec:	68 81 22 00 00       	push   $0x2281
    10f1:	6a 02                	push   $0x2
...
00001100 <getcmd>:
{
  ...
  printf(2, "$ ");
    ...
    110e:	68 d8 21 00 00       	push   $0x21d8
    1113:	6a 02                	push   $0x2
...
00001150 <panic>:
{
  ...
  printf(2, "%s\n", s);
    ...
    1159:	68 75 22 00 00       	push   $0x2275
    115e:	6a 02                	push   $0x2
...
00001170 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    1189:	ff 24 85 90 22 00 00 	jmp    *0x2290(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    11a9:	68 e2 21 00 00       	push   $0x21e2
    11ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    11fd:	68 f2 21 00 00       	push   $0x21f2
    1202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    1290:	68 db 21 00 00       	push   $0x21db
    1295:	e8 b6 fe ff ff       	call   1150 <panic>
    panic("fork");
    129a:	83 ec 0c             	sub    $0xc,%esp
    129d:	68 02 22 00 00       	push   $0x2202
    ...
    12d8:	68 07 22 00 00       	push   $0x2207
...
00001310 <fork1>:
{
  ...
  return pid;
    ...
    1325:	68 02 22 00 00       	push   $0x2202
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1339:	e8 a2 0d 00 00       	call   20e0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1369:	e8 72 0d 00 00       	call   20e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    13b7:	6a 0c                	push   $0xc
    13b9:	e8 22 0d 00 00       	call   20e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    13f7:	6a 0c                	push   $0xc
    13f9:	e8 e2 0c 00 00       	call   20e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    1437:	6a 08                	push   $0x8
    1439:	e8 a2 0c 00 00       	call   20e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
    ...
    1469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    148d:	50                   	push   %eax
    148e:	68 8c 28 00 00       	push   $0x288c
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    14dd:	50                   	push   %eax
    14de:	68 8c 28 00 00       	push   $0x288c
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    1536:	50                   	push   %eax
    1537:	68 84 28 00 00       	push   $0x2884
    ...
    1555:	50                   	push   %eax
    1556:	68 8c 28 00 00       	push   $0x288c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    15fd:	50                   	push   %eax
    15fe:	68 8c 28 00 00       	push   $0x288c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    1653:	68 29 22 00 00       	push   $0x2229
    1658:	53                   	push   %ebx
    1659:	56                   	push   %esi
  ...
  return cmd;
    ...
    16de:	68 0c 22 00 00       	push   $0x220c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    16ff:	68 2c 22 00 00       	push   $0x222c
    1704:	57                   	push   %edi
    1705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    174e:	68 43 22 00 00       	push   $0x2243
    1753:	57                   	push   %edi
    1754:	56                   	push   %esi
    ...
    1798:	68 35 22 00 00       	push   $0x2235
  ...
  cmd->eargv[argc] = 0;
    ...
    17ea:	68 2e 22 00 00       	push   $0x222e
...
00001800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
    181b:	68 48 22 00 00       	push   $0x2248
    1820:	56                   	push   %esi
    1821:	53                   	push   %ebx
...
00001870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
    ...
    18ab:	68 4a 22 00 00       	push   $0x224a
    18b0:	56                   	push   %esi
    18b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
    ...
    18c1:	68 46 22 00 00       	push   $0x2246
    18c6:	56                   	push   %esi
    18c7:	53                   	push   %ebx
...
00001910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
    191f:	68 2c 22 00 00       	push   $0x222c
    1924:	56                   	push   %esi
    1925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
    194b:	68 68 22 00 00       	push   $0x2268
    1950:	56                   	push   %esi
    1951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    19b5:	ff 24 85 a8 22 00 00 	jmp    *0x22a8(,%eax,4)
...
00001a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
    ...
    1a77:	68 f1 21 00 00       	push   $0x21f1
    1a7c:	53                   	push   %ebx
    1a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    1a9f:	52                   	push   %edx
    1aa0:	50                   	push   %eax
    1aa1:	68 6a 22 00 00       	push   $0x226a
    1aa6:	6a 02                	push   $0x2
    1aa8:	e8 d3 03 00 00       	call   1e80 <printf>
    panic("syntax");
    1aad:	c7 04 24 2e 22 00 00 	movl   $0x222e,(%esp)
    ...
    1de9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    1e17:	f7 f1                	div    %ecx
    1e19:	0f b6 92 c8 22 00 00 	movzbl 0x22c8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1e91:	0f 84 b3 00 00 00    	je     1f4a <printf+0xca>
  ap = (uint*)(void*)&fmt + 1;
    1e97:	8d 45 10             	lea    0x10(%ebp),%eax
    1e9a:	83 c6 01             	add    $0x1,%esi
  state = 0;
    1e9d:	31 ff                	xor    %edi,%edi
  ap = (uint*)(void*)&fmt + 1;
    1e9f:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    1ea2:	eb 2f                	jmp    1ed3 <printf+0x53>
    1ea4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    1ea8:	83 f8 25             	cmp    $0x25,%eax
    1eab:	0f 84 a7 00 00 00    	je     1f58 <printf+0xd8>
  write(fd, &c, 1);
    1eb1:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    1eb4:	83 ec 04             	sub    $0x4,%esp
    1eb7:	88 5d e2             	mov    %bl,-0x1e(%ebp)
    1eba:	6a 01                	push   $0x1
    1ebc:	50                   	push   %eax
    1ebd:	ff 75 08             	pushl  0x8(%ebp)
    1ec0:	e8 6d fe ff ff       	call   1d32 <write>
    1ec5:	83 c4 10             	add    $0x10,%esp
    1ec8:	83 c6 01             	add    $0x1,%esi
  for(i = 0; fmt[i]; i++){
    1ecb:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
    1ecf:	84 db                	test   %bl,%bl
    1ed1:	74 77                	je     1f4a <printf+0xca>
    if(state == 0){
    1ed3:	85 ff                	test   %edi,%edi
    c = fmt[i] & 0xff;
    1ed5:	0f be cb             	movsbl %bl,%ecx
    1ed8:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    1edb:	74 cb                	je     1ea8 <printf+0x28>
        state = '%';
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    1edd:	83 ff 25             	cmp    $0x25,%edi
    1ee0:	75 e6                	jne    1ec8 <printf+0x48>
      if(c == 'd'){
    1ee2:	83 f8 64             	cmp    $0x64,%eax
    1ee5:	0f 84 05 01 00 00    	je     1ff0 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    1eeb:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    1ef1:	83 f9 70             	cmp    $0x70,%ecx
    1ef4:	74 72                	je     1f68 <printf+0xe8>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    1ef6:	83 f8 73             	cmp    $0x73,%eax
    1ef9:	0f 84 99 00 00 00    	je     1f98 <printf+0x118>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1eff:	83 f8 63             	cmp    $0x63,%eax
    1f02:	0f 84 08 01 00 00    	je     2010 <printf+0x190>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    1f08:	83 f8 25             	cmp    $0x25,%eax
    1f0b:	0f 84 ef 00 00 00    	je     2000 <printf+0x180>
  write(fd, &c, 1);
    1f11:	8d 45 e7             	lea    -0x19(%ebp),%eax
    1f14:	83 ec 04             	sub    $0x4,%esp
    1f17:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    1f1b:	6a 01                	push   $0x1
    1f1d:	50                   	push   %eax
    1f1e:	ff 75 08             	pushl  0x8(%ebp)
    1f21:	e8 0c fe ff ff       	call   1d32 <write>
    1f26:	83 c4 0c             	add    $0xc,%esp
    1f29:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    1f2c:	88 5d e6             	mov    %bl,-0x1a(%ebp)
    1f2f:	6a 01                	push   $0x1
    1f31:	50                   	push   %eax
    1f32:	ff 75 08             	pushl  0x8(%ebp)
    1f35:	83 c6 01             	add    $0x1,%esi
      ...
      state = 0;
    1f38:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    1f3a:	e8 f3 fd ff ff       	call   1d32 <write>
  for(i = 0; fmt[i]; i++){
    1f3f:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
  write(fd, &c, 1);
    1f43:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    1f46:	84 db                	test   %bl,%bl
    1f48:	75 89                	jne    1ed3 <printf+0x53>
    }
  }
}
    1f4a:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1f4d:	5b                   	pop    %ebx
    1f4e:	5e                   	pop    %esi
    1f4f:	5f                   	pop    %edi
    1f50:	5d                   	pop    %ebp
    ...
    1f52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        state = '%';
    1f58:	bf 25 00 00 00       	mov    $0x25,%edi
    1f5d:	e9 66 ff ff ff       	jmp    1ec8 <printf+0x48>
    1f62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    1f68:	83 ec 0c             	sub    $0xc,%esp
    1f6b:	b9 10 00 00 00       	mov    $0x10,%ecx
    1f70:	6a 00                	push   $0x0
    1f72:	8b 7d d4             	mov    -0x2c(%ebp),%edi
    1f75:	8b 45 08             	mov    0x8(%ebp),%eax
    1f78:	8b 17                	mov    (%edi),%edx
    1f7a:	e8 61 fe ff ff       	call   1de0 <printint>
        ap++;
    1f7f:	89 f8                	mov    %edi,%eax
    1f81:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1f84:	31 ff                	xor    %edi,%edi
        ap++;
    1f86:	83 c0 04             	add    $0x4,%eax
    1f89:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    1f8c:	e9 37 ff ff ff       	jmp    1ec8 <printf+0x48>
    1f91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    1f98:	8b 45 d4             	mov    -0x2c(%ebp),%eax
    1f9b:	8b 08                	mov    (%eax),%ecx
        ap++;
    1f9d:	83 c0 04             	add    $0x4,%eax
    1fa0:	89 45 d4             	mov    %eax,-0x2c(%ebp)
        if(s == 0)
    1fa3:	85 c9                	test   %ecx,%ecx
    1fa5:	0f 84 8e 00 00 00    	je     2039 <printf+0x1b9>
        while(*s != 0){
    1fab:	0f b6 01             	movzbl (%ecx),%eax
      state = 0;
    1fae:	31 ff                	xor    %edi,%edi
        s = (char*)*ap;
    1fb0:	89 cb                	mov    %ecx,%ebx
        while(*s != 0){
    1fb2:	84 c0                	test   %al,%al
    1fb4:	0f 84 0e ff ff ff    	je     1ec8 <printf+0x48>
    1fba:	89 75 d0             	mov    %esi,-0x30(%ebp)
    1fbd:	89 de                	mov    %ebx,%esi
    1fbf:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1fc2:	8d 7d e3             	lea    -0x1d(%ebp),%edi
    1fc5:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    1fc8:	83 ec 04             	sub    $0x4,%esp
          s++;
    1fcb:	83 c6 01             	add    $0x1,%esi
    1fce:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    1fd1:	6a 01                	push   $0x1
    1fd3:	57                   	push   %edi
    1fd4:	53                   	push   %ebx
    1fd5:	e8 58 fd ff ff       	call   1d32 <write>
        while(*s != 0){
    1fda:	0f b6 06             	movzbl (%esi),%eax
    1fdd:	83 c4 10             	add    $0x10,%esp
    1fe0:	84 c0                	test   %al,%al
    1fe2:	75 e4                	jne    1fc8 <printf+0x148>
    1fe4:	8b 75 d0             	mov    -0x30(%ebp),%esi
      state = 0;
    1fe7:	31 ff                	xor    %edi,%edi
    1fe9:	e9 da fe ff ff       	jmp    1ec8 <printf+0x48>
    1fee:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 10, 1);
    1ff0:	83 ec 0c             	sub    $0xc,%esp
    1ff3:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1ff8:	6a 01                	push   $0x1
    1ffa:	e9 73 ff ff ff       	jmp    1f72 <printf+0xf2>
    1fff:	90                   	nop
  write(fd, &c, 1);
    2000:	83 ec 04             	sub    $0x4,%esp
    2003:	88 5d e5             	mov    %bl,-0x1b(%ebp)
    2006:	8d 45 e5             	lea    -0x1b(%ebp),%eax
    2009:	6a 01                	push   $0x1
    200b:	e9 21 ff ff ff       	jmp    1f31 <printf+0xb1>
        putc(fd, *ap);
    2010:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  write(fd, &c, 1);
    2013:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    2016:	8b 07                	mov    (%edi),%eax
  write(fd, &c, 1);
    2018:	6a 01                	push   $0x1
        ap++;
    201a:	83 c7 04             	add    $0x4,%edi
        putc(fd, *ap);
    201d:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    2020:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    2023:	50                   	push   %eax
    2024:	ff 75 08             	pushl  0x8(%ebp)
    2027:	e8 06 fd ff ff       	call   1d32 <write>
        ap++;
    202c:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    202f:	83 c4 10             	add    $0x10,%esp
      state = 0;
    2032:	31 ff                	xor    %edi,%edi
    2034:	e9 8f fe ff ff       	jmp    1ec8 <printf+0x48>
          s = "(null)";
    2039:	bb c0 22 00 00       	mov    $0x22c0,%ebx
        while(*s != 0){
    203e:	b8 28 00 00 00       	mov    $0x28,%eax
    2043:	e9 72 ff ff ff       	jmp    1fba <printf+0x13a>
    2048:	66 90                	xchg   %ax,%ax
    204a:	66 90                	xchg   %ax,%ax
    204c:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2051:	a1 04 29 00 00       	mov    0x2904,%eax
{
    2056:	89 e5                	mov    %esp,%ebp
    2058:	57                   	push   %edi
    2059:	56                   	push   %esi
    205a:	53                   	push   %ebx
    205b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bp = (Header*)ap - 1;
    205e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
    2061:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2068:	39 c8                	cmp    %ecx,%eax
    206a:	8b 10                	mov    (%eax),%edx
    206c:	73 32                	jae    20a0 <free+0x50>
    206e:	39 d1                	cmp    %edx,%ecx
    2070:	72 04                	jb     2076 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    2072:	39 d0                	cmp    %edx,%eax
    2074:	72 32                	jb     20a8 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
    2076:	8b 73 fc             	mov    -0x4(%ebx),%esi
    2079:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    207c:	39 fa                	cmp    %edi,%edx
    207e:	74 30                	je     20b0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    2080:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    2083:	8b 50 04             	mov    0x4(%eax),%edx
    2086:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    2089:	39 f1                	cmp    %esi,%ecx
    208b:	74 3a                	je     20c7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    208d:	89 08                	mov    %ecx,(%eax)
  freep = p;
    208f:	a3 04 29 00 00       	mov    %eax,0x2904
}
    2094:	5b                   	pop    %ebx
    2095:	5e                   	pop    %esi
    2096:	5f                   	pop    %edi
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    20a0:	39 d0                	cmp    %edx,%eax
    20a2:	72 04                	jb     20a8 <free+0x58>
    20a4:	39 d1                	cmp    %edx,%ecx
    20a6:	72 ce                	jb     2076 <free+0x26>
{
    20a8:	89 d0                	mov    %edx,%eax
    20aa:	eb bc                	jmp    2068 <free+0x18>
    20ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    bp->s.size += p->s.ptr->s.size;
    20b0:	03 72 04             	add    0x4(%edx),%esi
    20b3:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    20b6:	8b 10                	mov    (%eax),%edx
    20b8:	8b 12                	mov    (%edx),%edx
    20ba:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    20bd:	8b 50 04             	mov    0x4(%eax),%edx
    20c0:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    20c3:	39 f1                	cmp    %esi,%ecx
    20c5:	75 c6                	jne    208d <free+0x3d>
    p->s.size += bp->s.size;
    20c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    20ca:	a3 04 29 00 00       	mov    %eax,0x2904
    p->s.size += bp->s.size;
    20cf:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    20d2:	8b 53 f8             	mov    -0x8(%ebx),%edx
    20d5:	89 10                	mov    %edx,(%eax)
}
    20d7:	5b                   	pop    %ebx
    20d8:	5e                   	pop    %esi
    20d9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    20ec:	8b 15 04 29 00 00    	mov    0x2904,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    20f2:	8d 78 07             	lea    0x7(%eax),%edi
    20f5:	c1 ef 03             	shr    $0x3,%edi
    20f8:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
    20fb:	85 d2                	test   %edx,%edx
    20fd:	0f 84 9d 00 00 00    	je     21a0 <malloc+0xc0>
    2103:	8b 02                	mov    (%edx),%eax
    2105:	8b 48 04             	mov    0x4(%eax),%ecx
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    210a:	76 6c                	jbe    2178 <malloc+0x98>
    210c:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    2112:	bb 00 10 00 00       	mov    $0x1000,%ebx
    2117:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    211a:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    2121:	eb 0e                	jmp    2131 <malloc+0x51>
    2123:	90                   	nop
    2124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    2128:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    212a:	8b 48 04             	mov    0x4(%eax),%ecx
    212d:	39 f9                	cmp    %edi,%ecx
    212f:	73 47                	jae    2178 <malloc+0x98>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    2131:	39 05 04 29 00 00    	cmp    %eax,0x2904
    2137:	89 c2                	mov    %eax,%edx
    2139:	75 ed                	jne    2128 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    213b:	83 ec 0c             	sub    $0xc,%esp
    213e:	56                   	push   %esi
    213f:	e8 56 fc ff ff       	call   1d9a <sbrk>
  if(p == (char*)-1)
    2144:	83 c4 10             	add    $0x10,%esp
    2147:	83 f8 ff             	cmp    $0xffffffff,%eax
    214a:	74 1c                	je     2168 <malloc+0x88>
  hp->s.size = nu;
    214c:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    214f:	83 ec 0c             	sub    $0xc,%esp
    2152:	83 c0 08             	add    $0x8,%eax
    2155:	50                   	push   %eax
    2156:	e8 f5 fe ff ff       	call   2050 <free>
  return freep;
    215b:	8b 15 04 29 00 00    	mov    0x2904,%edx
      if((p = morecore(nunits)) == 0)
    2161:	83 c4 10             	add    $0x10,%esp
    2164:	85 d2                	test   %edx,%edx
    2166:	75 c0                	jne    2128 <malloc+0x48>
        return 0;
  }
}
    ...
    2172:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    2178:	39 cf                	cmp    %ecx,%edi
    217a:	74 54                	je     21d0 <malloc+0xf0>
        p->s.size -= nunits;
    217c:	29 f9                	sub    %edi,%ecx
    217e:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    2181:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    2184:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    2187:	89 15 04 29 00 00    	mov    %edx,0x2904
}
    218d:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    2190:	83 c0 08             	add    $0x8,%eax
}
    2193:	5b                   	pop    %ebx
    2194:	5e                   	pop    %esi
    2195:	5f                   	pop    %edi
    ...
    base.s.ptr = freep = prevp = &base;
    21a0:	c7 05 04 29 00 00 08 	movl   $0x2908,0x2904
    21a7:	29 00 00 
    21aa:	c7 05 08 29 00 00 08 	movl   $0x2908,0x2908
    21b1:	29 00 00 
    base.s.size = 0;
    21b4:	b8 08 29 00 00       	mov    $0x2908,%eax
    21b9:	c7 05 0c 29 00 00 00 	movl   $0x0,0x290c
    21c0:	00 00 00 
    21c3:	e9 44 ff ff ff       	jmp    210c <malloc+0x2c>
    21c8:	90                   	nop
    21c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        prevp->s.ptr = p->s.ptr;
    21d0:	8b 08                	mov    (%eax),%ecx
    21d2:	89 0a                	mov    %ecx,(%edx)
    21d4:	eb b1                	jmp    2187 <malloc+0xa7>
