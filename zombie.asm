    ...
    1359:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    1387:	f7 f1                	div    %ecx
    1389:	0f b6 92 50 17 00 00 	movzbl 0x1750(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15a4:	e9 8f fe ff ff       	jmp    1438 <printf+0x48>
          s = "(null)";
    15a9:	bb 48 17 00 00       	mov    $0x1748,%ebx
        while(*s != 0){
    ...
    15c1:	a1 f4 19 00 00       	mov    0x19f4,%eax
{
  ...
  freep = p;
    15ff:	a3 f4 19 00 00       	mov    %eax,0x19f4
}
    1604:	5b                   	pop    %ebx
    1605:	5e                   	pop    %esi
    1606:	5f                   	pop    %edi
    ...
    1616:	72 ce                	jb     15e6 <free+0x26>
{
  ...
  freep = p;
    163a:	a3 f4 19 00 00       	mov    %eax,0x19f4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    165c:	8b 15 f4 19 00 00    	mov    0x19f4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16a1:	39 05 f4 19 00 00    	cmp    %eax,0x19f4
  ...
  return freep;
    16cb:	8b 15 f4 19 00 00    	mov    0x19f4,%edx
    ...
    16f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    16f7:	89 15 f4 19 00 00    	mov    %edx,0x19f4
}
    ...
    base.s.ptr = freep = prevp = &base;
    1710:	c7 05 f4 19 00 00 f8 	movl   $0x19f8,0x19f4
    1717:	19 00 00 
    171a:	c7 05 f8 19 00 00 f8 	movl   $0x19f8,0x19f8
    1721:	19 00 00 
    base.s.size = 0;
    1724:	b8 f8 19 00 00       	mov    $0x19f8,%eax
    1729:	c7 05 fc 19 00 00 00 	movl   $0x0,0x19fc
    1730:	00 00 00 
